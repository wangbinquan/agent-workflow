#!/usr/bin/env bun
// Deterministic model replacement for e2e/business-workflow-scenarios.spec.ts.
//
// The production daemon, HTTP API, SQLite state, scheduler, Git worktree,
// wrapper generations, review state machine and output parser remain real.
// This executable only makes the model responses and worktree edits repeatable.
