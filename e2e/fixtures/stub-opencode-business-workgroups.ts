#!/usr/bin/env bun
// Deterministic model replacement for business-workgroup-scenarios.spec.ts.
//
// The daemon, public API, scheduler, SQLite state, worktrees, merge-back and
// envelope parsing remain real. This fixture only makes the model's business
// decisions repeatable and records every prompt for artifact-level assertions.
