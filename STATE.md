...
**最近更新**：2026-05-15（M5 进行中 — P-5-01/02/03-s1+s2-A+B/04/05/06/08/09/10/11 闭合，文档齐备）
...
P-5-01 + P-5-02 + P-5-04 + P-5-05 + P-5-06 + P-5-08 + P-5-09 + P-5-10 + P-5-11 闭合；P-5-03 stage 1（脚手架 + nav/auth/settings）+ stage 2 Phase A（9 个 list/new/detail 路由）+ stage 2 Phase B（编辑器 + launcher + canvas + NodeInspector）完成。后续工作：
- **P-5-03 stage 2 Phase C**：迁 components/*（NodeDetailDrawer / TaskOutputPanel / TaskStatusChip / AgentForm / SkillFileTree / Form / JsonField / ChipsInput / MarkdownEditor / ConfirmButton / DiffViewer 等）+ settings 剩下 4 个 tab 内字段 label，~15 文件
