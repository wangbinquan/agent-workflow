...
| AC-6  | 全量 backend 行为套件在真 PostgreSQL 上进 push CI | 当前1947测试文件；613构库文件/1271次调用，599构库文件无harness，426文件使用harness。候选累计234完整旧套件另有W28部分套件，本批5个旧DB例待新SHA；W28两平台1944文件各恰一次，选定Ubuntu113执行112过/1机制观察红 | 进行中 |
