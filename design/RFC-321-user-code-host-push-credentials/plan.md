...
- 状态：Done / Phase 2（2026-08-25）
- 当前完成度：T1–T20 已闭合；最终发布批次已入 `origin/main`，包含后继 SHA 的 hosted CI/visual 全绿
...
- ✅ 最终发布批次 `cde92d4c6`、`3a0e237c9` 均入 `origin/main`，并已证明为托管验收 SHA
...
RFC-321 于 2026-08-25 正式 Done。T1–T20、AC-1–AC-14、targeted E2E/visual 与发布证据全部闭合；
最终发布批次 `cde92d4c6`、`3a0e237c9` 均已入 `origin/main`。包含两笔提交的 `089015b1a` 上，
CI run `32806211369` 31/31 全绿，visual-regression run `32806211353` 1/1 全绿。全程按用户裁决
未运行本地 Bun gate，托管结果为最终权威门禁。
