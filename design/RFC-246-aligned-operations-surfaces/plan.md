...
- [ ] **RFC-246-T9**：精确路径暂存、提交、推送，并按 exact SHA 核验 CI/visual workflow。
...
- [ ] 本地门禁、截图人工检查、exact-SHA CI 与 hosted visual 全绿。

## 本地交付记录

2026-08-01 已完成 T3–T8：公共 toolbar/surface、Scheduled/Repos 业务视图与筛选、同构移动端重排、
读屏字段标签以及 macOS populated baselines 均已落地。完整 frontend **678 文件 / 5646 tests**，
全仓 typecheck/lint/format 全绿；RFC-246 Playwright **3/3**（含 1280/1024/901/390×844/
390×568、document/main/list overflow 与 axe critical/serious=0），Scheduled/Repos targeted visual
稳定复跑 **2/2**。T9 与最后一项验收须在固定提交和远端 hosted workflow 上闭合。
