...
- 数据来源：`architecture/current-report.json` 及同批 canonical manifests（sourceDigest `sha256:2908f370f1d36e2ba16daefd62cd5f6a910918ce99dc77733611403a684486ad`）
...
| 指标 | 当前值 |
| --- | --- |
| backend production TS 文件 | 1962 |
| `services/` 文件 | 326 |
| `modules/**` 文件 / 非空 context | 1348 / 17 |
| backend 值级 SCC / 全仓值级 SCC | 1 / 3 |
| `KNOWN_VIOLATIONS` | 8 |
| route→DB / transport→DB 值级边 | 0 / 0 |
| route/MCP `AppDeps` consumer 文件 | 0 |
| production ambient wiring seam | 494 |
| background work entries | 368 |
...
| --- | --- |
| `ambientWiring` | 494 |
| `architectureExceptions` | 5218 |
| `backgroundJobs` | 368 |
| `crossContextImports` | 6352 |
| `facades` | 326 |
| `governedFieldSurfaces` | 5 |
| `moduleSymbolOwners` | 26071 |
| `mutationEntrypoints` | 1936 |
| `nodeRunInsertSites` | 2 |
| `publicSurfaces` | 986 |
| `transactionExternalEffects` | 481 |
...
| role | 数量 |
| --- | --- |
| legacy-outbound | 3602 |
| legacy-inbound | 1422 |
| provider-mirror | 450 |
| infrastructure-external | 408 |
| offered-consumption | 190 |
| off-dag-offered | 92 |
...
### 6.2 零生产 consumer 的 public symbol 按 context（合计 142 / 986）
