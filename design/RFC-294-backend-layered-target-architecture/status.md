...
- 数据来源：`architecture/current-report.json` 及同批 canonical manifests（sourceDigest `sha256:c4520f71e0e68fffc4a4d5f29df42fe597ee5eec5287bf9c24720febf9d2e40e`）
...
| 指标 | 当前值 |
| --- | --- |
| backend production TS 文件 | 1798 |
| `services/` 文件 | 323 |
| `modules/**` 文件 / 非空 context | 1192 / 17 |
...
| resource-catalog / infrastructure | 101 |
