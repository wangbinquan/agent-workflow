...
- 数据来源：`architecture/current-report.json` 及同批 canonical manifests（sourceDigest `sha256:0cd8ccf434c44b4cb752bd6e2be767296bfc50c5de22fb4469e5f287f1be018d`）
...
| `publicSurfaces` | 986 |
| `transactionExternalEffects` | 482 |
