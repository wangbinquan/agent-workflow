...
- 数据来源：`architecture/current-report.json` 及同批 canonical manifests（sourceDigest `sha256:5f7b5f90883ceaad6b37b2330ac6206c78ce4c4fd85aa1e73172eddb5760a68f`）
...
| --- | --- |
| `ambientWiring` | 495 |
| `architectureExceptions` | 5316 |
| `backgroundJobs` | 369 |
| `crossContextImports` | 6448 |
| `facades` | 326 |
