...
- 数据来源：`architecture/current-report.json` 及同批 canonical manifests（sourceDigest `sha256:b9204bdc5e295cb7a856ed3e3230d260270b4d6cb6a49d2c8b0cb9636bf91c57`）
...
| `moduleSymbolOwners` | 26044 |
| `mutationEntrypoints` | 1931 |
