...
- 数据来源：`architecture/current-report.json` 及同批 canonical manifests（sourceDigest `sha256:76d48f9eaa3b489251db6fbf1c086203239828a015b42e4246298bff1b5befe8`）
...
| 指标 | 当前值 |
| --- | --- |
| backend production TS 文件 | 1841 |
| `services/` 文件 | 323 |
| `modules/**` 文件 / 非空 context | 1231 / 17 |
...
| --- | --- |
| `ambientWiring` | 494 |
| `architectureExceptions` | 4998 |
| `backgroundJobs` | 363 |
| `crossContextImports` | 5602 |
| `facades` | 323 |
| `governedFieldSurfaces` | 5 |
| `moduleSymbolOwners` | 25438 |
| `mutationEntrypoints` | 1815 |
| `nodeRunInsertSites` | 2 |
| `publicSurfaces` | 981 |
| `transactionExternalEffects` | 320 |
...
| role | 数量 |
| --- | --- |
| legacy-outbound | 3358 |
| legacy-inbound | 1451 |
| infrastructure-external | 302 |
| offered-consumption | 165 |
| off-dag-offered | 91 |
