...
- 数据来源：`architecture/current-report.json` 及同批 canonical manifests（sourceDigest `sha256:e3b4efcd5c1a3c747721b7b1f7475932a55e7fc3e9ec30ec04b2ade524612f2d`）
...
| 指标 | 当前值 |
| --- | --- |
| backend production TS 文件 | 1949 |
| `services/` 文件 | 326 |
| `modules/**` 文件 / 非空 context | 1333 / 17 |
...
| --- | --- |
| `ambientWiring` | 494 |
| `architectureExceptions` | 5291 |
| `backgroundJobs` | 370 |
| `crossContextImports` | 6337 |
| `facades` | 326 |
| `governedFieldSurfaces` | 5 |
| `moduleSymbolOwners` | 26118 |
...
| task-execution / infrastructure | 126 |
