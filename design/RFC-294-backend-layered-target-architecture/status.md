...
- 数据来源：`architecture/current-report.json` 及同批 canonical manifests（sourceDigest `sha256:19764fe60645f2898b2e837348592a2128dd35e644dd79582a31d810453318e2`）
...
| 指标 | 当前值 |
| --- | --- |
| backend production TS 文件 | 1799 |
| `services/` 文件 | 323 |
| `modules/**` 文件 / 非空 context | 1193 / 17 |
...
| --- | --- |
| `ambientWiring` | 494 |
| `architectureExceptions` | 4794 |
| `backgroundJobs` | 338 |
| `crossContextImports` | 5328 |
| `facades` | 323 |
| `governedFieldSurfaces` | 5 |
| `moduleSymbolOwners` | 25063 |
...
| resource-catalog / infrastructure | 102 |
