...
- 数据来源：`architecture/current-report.json` 及同批 canonical manifests（sourceDigest `sha256:fd2c9932c10b9fc9e02153cf585251f4719f881cb5749f28ee6c7b140d1c3b5e`）
...
| --- | --- |
| `ambientWiring` | 494 |
| `architectureExceptions` | 4734 |
| `backgroundJobs` | 335 |
| `crossContextImports` | 5268 |
| `facades` | 322 |
| `governedFieldSurfaces` | 5 |
| `moduleSymbolOwners` | 24942 |
...
### 6.2 零生产 consumer 的 public symbol 按 context（合计 137 / 983）
