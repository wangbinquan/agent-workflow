...
- 数据来源：`architecture/current-report.json` 及同批 canonical manifests（sourceDigest `sha256:29a32f691da5399c5ff298cd433b38a3d790778a562bdfd0f1b5159754388a3f`）
...
| production ambient wiring seam                | 472      |
...
| ---------------------------- | ------ |
| `ambientWiring`              | 472    |
| `architectureExceptions`     | 2171   |
| `backgroundJobs`             | 282    |
| `crossContextImports`        | 2224   |
| `facades`                    | 385    |
