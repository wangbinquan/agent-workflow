...
- 数据来源：`architecture/current-report.json` 及同批 canonical manifests（sourceDigest `sha256:ca28e3309369f5e7763c8b163450e078d44e4c15b0a8769a1e09eee7b39a0e06`）
...
| 指标 | 当前值 |
| --- | --- |
| backend production TS 文件 | 1093 |
| `services/` 文件 | 381 |
| `modules/**` 文件 / 非空 context | 537 / 14 |
...
| --- | --- |
| `ambientWiring` | 460 |
| `architectureExceptions` | 1881 |
| `backgroundJobs` | 273 |
| `crossContextImports` | 1926 |
| `facades` | 381 |
| `governedFieldSurfaces` | 5 |
| `moduleSymbolOwners` | 19960 |
| `mutationEntrypoints` | 1163 |
...
| resource-catalog / application | 22 |
...
| resource-catalog / infrastructure | 11 |
...
| resource-catalog / composition | 6 |
...
### 6.2 零生产 consumer 的 public symbol 按 context（合计 136 / 596）
