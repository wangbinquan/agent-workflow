...
- 数据来源：`architecture/current-report.json` 及同批 canonical manifests（sourceDigest `sha256:b52a2452295d3cdc4f3a7df2b86d45d45a4bef8b2c99c93a35d04397ddaf06b7`）
...
| --- | --- |
| `ambientWiring` | 494 |
| `architectureExceptions` | 5297 |
| `backgroundJobs` | 370 |
| `crossContextImports` | 6345 |
| `facades` | 326 |
| `governedFieldSurfaces` | 5 |
| `moduleSymbolOwners` | 26130 |
...
| task-execution / infrastructure | 130 |
