...
先产出合同与行为 oracle，生产 cutover 另号获批。三者当前均 Draft。E6 等 E4b；E10 等 E9 与 task query；
...
| N19  | RFC-360 / W4-E4b（Draft）           | RM profile/admin/probe/model/selection 纵切，同步本域 B/D                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                    | 用户批准后优先；与 TaskExecution root 接线串行                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                 |
| N20  | RFC-361 / W4-E9 第一刀（Draft）     | EC resource/fixture providers 归 RC/TE，保留 receipt/wire                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                    | 可独立实施；不关闭 Reaction/Event/完整 E9                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                      |
| N21  | RFC-362 / W4-E1 合同前置（Draft）   | SC offered / Task required 合同与当前 launch 行为 oracle                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                     | 本 RFC 不切生产；后继 cutover 另号获批                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                         |
...
W4-C 立下的转交口径处理剩余 facade 与不属于 memory 的 exact id，逐条见其 `plan.md §4.1`）。当前 RFC-360/361/362 均为 Draft，尚未开启其 production migration；W6 可消费 P0-B，但仍须通过本 wave 的功能、transaction、compatibility 与 exact-SHA hosted gate。
...
- [ ] **E1 task launch admission**（RFC-362 Draft 仅准备合同，生产 cutover 另号）：消费 W2-B 已获批并稳定的 task admission 合同，不在 W4 偷改 RFC-287 行为。
...
- [ ] **E4b runtime-management**（RFC-360 Draft）：profile/admin/probe 与 runtime-selection participant 独立切换/回滚，保持 per-NodeRun
...
- [ ] **E9 digital-employee / event-center / execution-contract**（RFC-361 Draft 先做 EC provider slice）：以 RFC-310 OS 已落的 Case/Context/Attention/Reaction/Channel、
