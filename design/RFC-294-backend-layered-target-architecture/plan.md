...
- [ ] **E1 task launch admission**（RFC-362 Done 仅合同准备完成，生产 cutover 另号）：消费 W2-B 已获批并稳定的 task admission 合同，不在 W4 偷改 RFC-287 行为。
...
- [ ] **E9 digital-employee / event-center / execution-contract**（RFC-361 Done 仅关闭 EC provider slice）：以 RFC-310 OS 已落的 Case/Context/Attention/Reaction/Channel、
