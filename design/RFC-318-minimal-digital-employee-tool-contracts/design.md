...
- 主实现 `985483b02`、平台节点展示归属修复 `721eaf79a` 及后续 RFC-318 收口提交均已进入 `origin/main`。
- 直接收口 SHA `ff1290659` 的 CI `32725484666` 被更高优先级主干推送取消；取消前 RFC-318 后端合同门 10/10 与目标 Playwright 已通过，因此只作为定向证据，不冒充全仓绿。
- `ff1290659` 是精确后继 SHA `089015b1a53071b151f2e6b73268517390eb4b55` 的祖先；该 SHA 的 CI `32806211369` 为 31/31 jobs success，visual `32806211353` 为 1/1 job success。
- 以上 hosted 证据完成 RFC-318 的发布验收；RFC 状态于 2026-08-25 收口为 Done。
