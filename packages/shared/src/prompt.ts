...
// RFC-334: neutral attempt-cap arithmetic now lives in backend
// `platform/contracts/retryAttemptCap`; TaskExecution retry shape/state lives in
// `modules/task-execution/domain/envelopeRetryPolicy`. Shared retains only the
// protocol default and prompt rendering contracts used by multiple engines.
