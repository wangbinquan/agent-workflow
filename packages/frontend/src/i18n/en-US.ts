...
export const enUS: Resources = {
  nav: {
    ...
    inbox: {
      ...
      tabClarify: 'Clarify',
      tabFusion: 'Fusions',
      fusionTitle: 'Fuse → {{skill}}',
      fusionSubtitle: 'skill change awaiting approval · {{n}} memories',
      ...
      pendingMemoryGroup: 'Pending memory ({{count}})',
      pendingMemoryEmpty: 'No memory candidates',
