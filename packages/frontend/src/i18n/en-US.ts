...
export const enUS: Resources = {
  ...
  account: {
    ...
    tokensRetiredTitle: 'New token creation is disabled',
    tokensRetiredDescription:
      'Existing tokens continue to work until they expire or you revoke them. This page remains as a safe retirement path.',
    noPatsDescription:
