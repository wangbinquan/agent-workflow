...
export const enUS: Resources = {
  ...
  code: {
    ...
    subtitle:
      'Build reusable employee capabilities and rule-driven work instructions; live execution stays in Tasks',
    build: {
      title: 'Digital employee capability construction',
      employees: {
        title: 'Employee work instructions',
        body: 'Define each ordered business step, its executor, retries, and deterministic next action.',
      },
      executors: {
        title: 'Executor library',
        body: 'Manage the AI, programs, other employees, and external systems a step may select.',
      },
      assignments: {
        title: 'Repository scope',
        body: 'Choose which published employee and rules apply to each repository or repository group.',
      },
      outcomes: {
        title: 'Outcomes',
        body: 'Use completed work and capability signals to adjust employee strategies.',
      },
      runtimeTitle: 'Execution is managed with every other task',
      runtimeBody:
    ...
    journey: {
      ...
      ownerName: {
        ...
        committer: 'Committer',
        platform: 'Platform',
        'digital-employee': 'Another digital employee',
        'external-system': 'External system',
      },
      noActionRequired: 'No action needed from you; the system continues automatically',
      unavailable: 'The current account lacks: {{reason}}',
      resumeAt: 'Checks again around {{time}}',
      deadlineAt: 'Waits no later than {{time}}',
      step: {
        'employee-setup': {
          define: 'Define employee',
          publish: 'Publish employee',
          assign: 'Set scope',
          launch: 'Give first work',
        },
        'mission-delivery': {
          intake: 'Receive requirement',
          develop: 'Develop & repair',
      ...
      next: {
        createEmployee: 'Create a digital employee',
        employeeArchived: 'Create a new digital employee',
        configureAndPublish: 'Complete this employee’s work instructions',
        publishEmployee: 'Publish this digital employee',
        assignRepository: 'Set the repositories it serves',
        launchFirstMission: 'Give it the first piece of work',
        answerQuestions: 'Answer the employee’s questions',
        waitChildMission: 'Wait for another employee to finish',
        openApproval: 'Open and complete the approval',
        waitApproval: 'Wait for the approval result',
        retryMission: 'Fix the cause and retry',
        attachMergeRequest: 'Attach the manually created MR',
        resumeAutomation: 'Resume automated development',
        reviewAndMerge: 'Open the MR, review and merge',
        watchMergeRequest: 'Keep watching the MR',
        continueAutomatically: 'Continue automated development',
        settleTransition: 'Settle the in-flight operation',
        viewOutcome: 'View this outcome',
        viewNoChangeOutcome: 'View the no-change outcome',
        launchAnotherMission: 'Give another piece of work',
      },
      detail: {
        setupDefineDetail: 'Define what this employee owns and the ordered steps it performs.',
        setupPublishDetail:
          'Check its work steps and connections; publication makes it selectable.',
        setupAssignDetail: 'Bind the published employee to a repository, group, or global default.',
        setupLaunchDetail: 'Setup is ready for a body, files, or an external requirement ID.',
        createEmployeeDetail:
          'Choose a general, Java, or C++ preset; creation opens the complete work manual.',
        employeeArchivedDetail: 'This employee is archived. Create a new one to continue.',
        configureAndPublishDetail:
          'Complete ordered steps, problem handling, cross-repo collaboration, and connections.',
        publishEmployeeDetail:
          'All rules and dependencies validate; publish and proceed to repository scope.',
        assignRepositoryDetail:
          'Choose a repository or group; after save, launch the first mission from the same page.',
        launchFirstMissionDetail:
          'Write a body, upload files with target paths, or enter only an external ID.',
        missionIntakeDetail:
          'The platform is acquiring and freezing inputs and asks only when the source is ambiguous.',
        missionDevelopDetail:
          'Published steps drive the work; an Agent or program produces only the current step result.',
        missionPublishDetail:
          'The platform validates the real workspace, then commits, pushes, and creates or updates the MR.',
        missionCareDetail:
          'The platform collects reviews, pipelines, and approvals and repairs them from rules.',
        missionMergedDetail: 'The authoritative merge was observed and the lifecycle is complete.',
        terminalCompleteDetail:
          'The full execution trail and outcome remain available; the platform writes no more.',
        terminalStoppedDetail: 'This mission stopped; inspect the trail or launch another.',
        settleTransitionDetail:
          'The platform reconciles dispatched effects before completing cancellation or handoff.',
        answerQuestionsDetail:
          'The form is directly below; submitted answers become the frozen next input.',
        waitChildMissionDetail:
          'An independent mission is progressing in another repository; the parent resumes on its completion rule.',
        openApprovalDetail:
          'Approval materials were submitted; an authorized reviewer acts externally while the platform observes.',
        waitApprovalDetail:
          'The request and deadline are durable; webhook or short polling obtains authoritative status.',
        retryMissionDetail:
          'Correct the exact block in configuration or external state, then restore from a deterministic scene.',
        attachMergeRequestDetail:
          'Enter the existing MR; the platform verifies repository, branches, and head.',
        resumeAutomationDetail:
          'Refresh current facts and resume from published rules, not the pre-handoff workspace.',
        reviewAndMergeDetail:
          'Automation holds are clear. The platform never merges; a committer performs final review and merge.',
        watchMergeRequestDetail:
          'No manual refresh is needed; comments, red gates, conflicts, and merge events wake rules.',
        continueAutomaticallyDetail:
          'No action is needed from you; the platform is executing the rule-selected next step.',
      },
      wake: {
        settleTransitionWake: 'Updates after external effects settle',
        waitChildMissionWake: 'Resumes on child state or deadline',
        waitApprovalWake: 'Resumes on approval webhook or scheduled observation',
        waitMergeWake: 'Updates on code-host merge facts',
        watchMergeRequestWake: 'Continues on webhook or periodic fact collection',
        continueAutomaticallyWake: 'Continues when the action finishes or resume time arrives',
      },
    },
    employeePlaybook: {
      ...
      createAndConfigure: 'Create and view work manual',
      createHint:
        'Choose the closest preset; a complete initial flow is generated and creation opens the next step.',
      employeesEmpty: 'No digital employees yet',
      employeesEmptyHint: 'Create one, publish it, and set the repositories it serves.',
      basics: 'What it owns',
      preset: 'Project specialty',
      presetGeneral: 'General development',
      presetJava: 'Java projects',
      presetCpp: 'C / C++ projects',
      ruleSet: 'Business rule set',
      ruleSetHint:
        'Rules decide execution, retries, and stopping; AI does not choose the next step.',
      chooseRuleSet: 'Choose a published rule set',
      noRuleSet: 'Publish a business rule set first',
      detectedExecutors: '{{count}} published executors will seed the initial steps.',
      enabled: 'Accept new work',
      enabledShort: 'Enabled',
      disabled: 'Disabled',
      colSteps: 'Work steps',
      colStatus: 'Intake status',
      stepCount: '{{count}} steps',
      steps: 'What happens after work arrives',
      stepsHint: 'Steps run top to bottom; each says when, who, and where success or failure goes.',
      addStep: 'Add step',
      stepNumber: 'Step {{number}}',
      stepName: 'Step name',
      stepDescription: 'What this step achieves',
      trigger: 'When it runs',
      triggerAlways: 'Whenever this step is reached',
      triggerRequirementReady: 'When requirement materials are complete',
      triggerReviewFeedback: 'When unhandled review feedback arrives',
      triggerPipelineFailed: 'When a pipeline gate fails',
      triggerMergeConflict: 'When the MR conflicts',
      executorType: 'Who completes it',
      executor: 'Specific executor',
      executorPlatform: 'Fixed platform action',
      executorAgent: 'AI Agent',
      executorScript: 'Program / script',
      executorEmployee: 'Another digital employee (cross-repo)',
      executorApprovalPrepare: 'Prepare approval materials (Agent or program)',
      executorApprovalSubmit: 'Submit approval (program)',
      ...
      executorName: 'Executor business name',
      executorAbility: 'Work it can perform',
      selectAgent: 'AI Agent',
      programLanguage: 'Program language',
      programPath: 'Published program path or reference',
      executorInstructions: 'Execution instructions',
      approvalProgramPath: 'Approval connector program',
      approvalProgramHint:
        'The program must implement submit, idempotency lookup, and status observation.',
      capabilityRequirementAnalyze: 'Understand and scope requirements',
      capabilityChangeImplement: 'Implement code changes',
      capabilityChangeReview: 'Review the proposed change',
      capabilityVerificationRepair: 'Repair local verification failures',
      capabilityFeedbackApply: 'Address MR review feedback',
      capabilityPipelineRepair: 'Repair pipeline gate failures',
      capabilityConflictRepair: 'Repair merge conflicts',
      capabilityExternalReview: 'Perform external MR review',
      capabilityProblemClassify: 'Recognize and classify problems',
      capabilityApprovalPrepare: 'Prepare approval materials',
      platformAction: 'Platform action',
      childEmployee: 'Digital employee to invoke',
      chooseEmployee: 'Choose a published employee',
      targetRepository: 'Its target repository',
      childCompletion: 'Completion condition',
      completionAutomationReady: 'Automation work complete',
      completionReadyToMerge: 'Child MR ready to merge',
      completionMerged: 'Child MR merged',
      completionCompleted: 'Child mission complete',
      approvalDraftExecutor: 'Who prepares approval materials',
      approvalType: 'Approval business type',
      approvalSystem: 'Approval system',
      chooseApprovalSystem: 'Choose a published approval system',
      pollMinutes: 'Check interval in minutes',
      deadlineHours: 'Maximum wait in hours',
      sameSceneRetries: 'Retries in the same scene',
      freshSceneRetries: 'Roll back and rerun count',
      whenRetriesExhausted: 'After retries are exhausted',
      afterSuccess: 'After this step succeeds',
      continueByRules: 'Return to rule evaluation',
      finishCurrentPlaybook: 'Finish this work sequence',
      whenRejected: 'If an external request is rejected',
      whenExpired: 'If waiting expires',
      useExhaustedAction: 'Use the action above',
      waitForSeveralSteps: 'Wait for several step results before continuing',
      stepsToWaitFor: 'Results to wait for',
      waitCondition: 'Continue when',
      waitAll: 'All selected steps succeed',
      waitAny: 'Any selected step succeeds',
      waitQuorum: 'A specified count succeeds',
      quorumCount: 'Required successes',
      whenJoinDeadline: 'At the deadline',
      whenJoinPartial: 'When success is no longer possible',
      blockAndAskHuman: 'Block and explain the cause',
      handoffToHuman: 'Hand off and keep tracking',
      moveUp: 'Move up',
      moveDown: 'Move down',
      problems: 'When an MR or pipeline problem occurs',
      problemsHint:
        'Define types, producers, and repairers; unmatched problems are never guessed by AI.',
      problemTypes: '1. Problem types it recognizes',
      problemTypeNumber: 'Problem type {{number}}',
      problemName: 'Business name',
      evidenceSource: 'Detected from',
      evidencePipeline: 'Pipeline gate',
      evidenceVerification: 'Local verification',
      evidenceFeedback: 'MR review feedback',
      evidenceConflict: 'Branch conflict',
      evidenceMr: 'MR state',
      priority: 'Processing priority',
      repairable: 'Allow automatic repair',
      unknownFallback: 'Explicit fallback for unclassified problems',
      newProblemType: 'Problem type {{number}}',
      addProblemType: 'Add problem type',
      problemProducers: '2. Who recognizes problems',
      problemProducerNumber: 'Problem producer {{number}}',
      producerName: 'Producer name',
      producerCanReport: 'Allowed result types',
      newProducer: 'Problem producer {{number}}',
      addProducer: 'Add producer',
      problemHandlers: '3. Who repairs each type',
      problemHandlerNumber: 'Repair rule {{number}}',
      problemType: 'Problem type',
      verifyAfterRepair: 'Run again after repair',
      addHandler: 'Add repair rule',
      connections: 'Business systems it uses',
      connectionsHint:
        'Choose business names here; platform admins publish the underlying programs and secrets.',
      requirementSystem: 'Requirement / issue system',
      pipelineSystem: 'Pipeline-gate system',
      noConnection: 'No connection',
      manualTitle: 'Work manual',
      responsibility: 'Responsibility',
      sequenceTitle: 'Standard work sequence',
      noBusinessSteps: 'No work steps configured.',
      triggerLabel: 'Trigger: {{trigger}}',
      executorLabel: 'Executor: {{executor}}',
      successLabel: 'On success: {{target}}',
      failureLabel: 'Retry {{same}} + {{fresh}}, then {{target}}',
      problemsSummary: 'Problem recognition and repair',
      noProblems: 'No automatic problem classification; unknown problems block for a human.',
      externalCollaboration: 'Cross-repo and approvals',
      noExternalCollaboration: 'No cross-repo employee or external approval steps.',
      connectionsSummary: 'Business-system connections',
      assignmentSummary: 'Usage scope',
      assignmentCount: 'Active in {{count}} scopes',
      readyToPublish: 'Rules validate and are ready to publish',
      needsAttention: '{{count}} items need attention',
      technicalDetails: 'Advanced: technical implementation and full configuration',
      success: 'On success',
      failure: 'On failure',
      unavailableResource: 'Selected resource is unavailable or not visible',
      unconfigured: 'Not configured',
      problemFlow: 'Recognize: {{producer}} · Repair: {{handler}}',
      childWaitSummary: 'Target repository: {{repository}} · Wait for: {{completion}}',
      target: {
        reconcile: 'Return to the platform and continue from fresh facts',
        complete: 'Complete the mission',
        block: 'Block and explain the cause',
        handoff: 'Hand off and keep tracking',
      },
      completion: {
        'automation-ready': 'Automation work complete',
        'ready-to-merge': 'MR ready to merge',
        merged: 'MR merged',
        completed: 'Mission complete',
      },
      platform: {
        requirement_acquire: 'Download and freeze requirement materials',
        repository_inspect: 'Inspect repository facts',
        pipeline_collect: 'Collect pipeline gates and logs',
        verification_run: 'Run programmatic verification',
        change_publish: 'Commit and push changes',
        mr_ensure: 'Create or update the MR',
        mr_collect: 'Collect MR state and review feedback',
        pipeline_rerun: 'Rerun failed gates',
        pipeline_trigger: 'Trigger a missing pipeline',
        readiness_evaluate: 'Evaluate whether the MR is merge-ready',
      },
    },
    control: {
      eyebrow: 'Rule-driven AI engineering colleague',
      headline: 'You provide the requirement. The digital employee keeps the MR merge-ready.',
      description:
        'The platform runs published employee capabilities, execution policy, and repository assignments. Agents only edit files inside an envelope; the platform owns commits, pushes, MRs, and gate supervision.',
      inbox: 'Mission inbox',
      outcomes: 'Outcomes',
      startWork: 'Give work to an employee',
      checking: 'Checking setup',
      setupReady: 'Ready to accept work',
      setupNeeded: 'Complete capability setup',
      setupTitle: 'Digital employee setup checklist',
      unavailable: 'Not visible',
      readyCount: '{{count}} ready',
      actionNeeded: 'Set up',
      employeeTitle: '1. Define employee capabilities',
      employeeBody:
        'Choose C++, Java, or other templates and bind Agents, verification, requirement acquisition, and pipeline-gate programs.',
      policyTitle: '2. Publish execution policy',
      policyBody:
        'Define when to act, retries, budgets, and stop conditions. Every decision remains attributable to a rule.',
      assignmentTitle: '3. Assign to repositories',
      assignmentBody:
        'Bind published employees and policies at repository, repository-group, or global-default scope.',
      operationsTitle: '4. Supervise missions and MRs',
      operationsBody:
        '{{count}} active missions. The platform tracks feedback, pipelines, conflicts, and final merge.',
      readyMissions: '{{count}} merge-ready MRs',
    },
    operations: {
      eyebrow: 'Live operations',
      title: 'Current work, by accountable stage',
      subtitle:
        'Open a mission to act on it. Historical results are kept out of this control surface.',
      allMissions: 'Open mission inbox',
      attentionTitle: 'Needs a person',
      attentionHint: 'These missions cannot progress until the stated input or block is resolved.',
      readyTitle: 'Ready for a committer',
      readyHint:
        'All automated work is done. The platform keeps watching; a committer decides when to merge.',
      noActiveTitle: 'No live missions',
      noActiveBody: 'Give the digital employee a requirement when there is work to do.',
      stageAria: 'Live mission stages',
      employeeFallback: 'Repository-assigned employee',
      blockedReason: 'Blocked: {{reason}}',
      awaitingInput: 'Waiting for requested information',
      missionUpdated: 'updated {{time}}',
      missionUpdatedUnknown: 'time unavailable',
      stage: {
        intake: {
          title: '1. Requirement intake',
          body: 'Acquire files, clarify input and freeze the requirement bundle.',
          empty: 'No requirement is waiting here.',
        },
        develop: {
          title: '2. Develop and repair',
          body: 'Run bounded Agent actions and validate their envelopes.',
          empty: 'No Agent action is in flight.',
        },
        publish: {
          title: '3. Verify and publish',
          body: 'Run programmatic checks, commit, push and create or update the MR.',
          empty: 'No candidate is being published.',
        },
        care: {
          title: '4. Tend the MR',
          body: 'Watch pipeline gates and review feedback until the MR is merge-ready.',
          empty: 'No MR currently needs automated tending.',
        },
      },
    },
    tab: {
    ...
    config: {
      ...
      colName: 'Name',
      colDetail: 'Kind detail',
      colRevision: 'Published',
      colVisibility: 'Visibility',
      notPublished: 'Draft only',
      archived: 'Archived',
      emptyTitle: 'Nothing configured yet',
      emptyBody: 'Create a resource to start configuring this digital employee surface.',
      create: 'Create',
      creating: 'Creating…',
      ...
      publishBlocked: 'Publish blocked — fix these first',
      archive: 'Archive',
      archiveTitle: 'Archive this resource?',
      archiveBody: '“{{name}}” stays resolvable for existing references but leaves the pickers.',
      acl: 'Access',
      draftJsonTitle: 'Draft content (JSON)',
      draftJsonHint:
        'Publish runs the full schema and closure validation; errors are listed per item.',
      draftInvalidJson: 'Draft is not valid JSON',
      description: 'Description',
      promptSupplement: 'Prompt supplement',
      promptHint:
        'Domain knowledge added before the fixed protocol block; cannot change the contract.',
      employeeSummary: 'Employee profile',
      routesTitle: 'Capability routes',
      noRoutes: 'No capability routes yet — publish requires at least one.',
      colCapability: 'Capability',
      colRules: 'Rules',
      colFallback: 'Fallback template',
      bindingsTitle: 'Bindings',
      defaultPolicy: 'Default policy',
      requirementSources: 'Requirement sources',
      pipelineProviders: 'Pipeline providers',
      templateSummary: 'Template contract',
      executor: 'Executor agent',
      verificationProfile: 'Verification profile',
      retryDefaults: 'Retry defaults',
      retryText: 'same-session {{same}}, fresh-session {{fresh}}',
      profileSummary: 'Verification steps',
      ...
      editor: {
        ...
        versionedRefHint:
          'Pin an exact published revision so running missions do not drift with later drafts.',
        resourceId: 'Resource ID',
        revision: 'Published revision',
        routesHint:
          'Choose a fallback template for each capability. Edit advanced fact rules in the JSON section at the bottom.',
        routeNumber: 'Capability route {{number}}',
        fallbackHint: 'Published action template used when no ordered rule matches.',
        rulesPreserved: '{{count}} advanced selection rules are preserved.',
        addRoute: 'Add capability route',
        requirementSourcesHint:
          'Bind a programmatic acquisition adapter when missions may start from an external requirement ID.',
        sourceNumber: 'Requirement source {{number}}',
        sourceKey: 'Requirement source key',
        adapterRef: 'Exact adapter revision',
        defaultSource: 'Use as the default requirement source',
        addSource: 'Add requirement source',
        pipelineProvidersHint:
          'Bind the program that collects gate details from your internal system. Large logs are staged under .agent-workflow/pipeline.',
        providerNumber: 'Pipeline provider {{number}}',
        providerKey: 'Pipeline provider key',
        addProvider: 'Add pipeline provider',
        executionSection: 'Executor and runtime contract',
        capabilityLocked: 'The capability is fixed when the template is created.',
        contractVersion: 'Capability contract version',
        executorKind: 'Executor kind',
        agent: 'Single agent',
        workgroup: 'Workgroup',
        workgroupRef: 'Workgroup ref',
        runtimeProfile: 'Runtime profile',
        resourcesSection: 'Knowledge, tools and workspace boundaries',
        labels: 'Labels',
        skills: 'Skill refs',
        mcps: 'MCP refs',
        readOnlyResources: 'Read-only resources',
        contextProfile: 'Context profile (optional)',
        writablePathPolicy: 'Writable-path policy (optional)',
        protectedPathClasses: 'Additional protected path classes',
        sameSessionRetries: 'Same-session retries',
        freshSessionRetries: 'Fresh-session reruns',
        verificationStrategy: 'Verification strategy',
        firstFailure: 'Stop on first failure',
        collectAll: 'Run and collect every step',
        maxParallel: 'Maximum parallel steps',
        verificationStepsHint:
          'Each result is decided by the program exit code; the Agent never interprets log prose as pass or fail.',
        stepNumber: 'Verification step {{number}}',
        argsRef: 'Arguments ref (optional)',
        ...
        advancedJsonHint:
          'Use only for advanced predicates, evidence selectors, and similar fields. Apply changes back to the form before saving.',
        applyAdvanced: 'Apply JSON to form',
        applyAdvancedFirst: 'Apply the advanced JSON back to the form before saving.',
        draftMustBeObject: 'The draft must be a JSON object at the top level.',
      },
    },
    assignments: {
      title: 'Employee assignments',
      description: 'Repository, group and global digital-employee bindings',
      create: 'New assignment',
      empty: 'No assignments yet',
      dialogTitle: 'Edit assignment',
      globalScope: 'Global default',
      repoRef: 'Repository',
      groupRef: 'Repository group',
      publishedOnly: 'Only published resources are offered',
      warnEmployeeUnpublished: 'Employee has no published revision',
      warnPolicyUnpublished: 'Policy has no published revision',
      colScope: 'Scope',
      colEmployee: 'Employee',
      colSelectionPolicy: 'Selection policy',
      colExecutionPolicy: 'Execution policy',
      colSourceKey: 'Default source key',
      scope: {
    ...
    missions: {
      ...
      subtitle: 'Rule-driven digital-employee missions from requirement to merge request',
      backToCode: '← Code',
      backToList: '← Missions',
      launch: 'Launch mission',
      launching: 'Launching…',
      launchTitle: 'Launch a development mission',
      emptyTitle: 'No missions yet',
      emptyBody:
        'Launch one from a requirement body, uploaded files, or an external requirement id.',
      colMission: 'Mission',
      colStatus: 'Status',
      ...
      kindBody: 'Body',
      kindUploads: 'Files',
      kindExternal: 'External id',
      formRepository: 'Repository',
      pickRepository: 'Pick a repository…',
      formEmployee: 'Digital employee',
      employeeHint: 'Published employees only; leave empty to use the repository assignment.',
      pickEmployee: 'Pick an employee…',
      formTitle: 'Title',
      formBody: 'Requirement body',
      formExternalId: 'External requirement id',
      formSourceKey: 'Source key',
      sourceKeyHint: 'Optional; defaults to the employee requirement source.',
      formUploads: 'Files and repository target paths',
      uploadsHint: 'Every file needs an explicit repository-relative target path.',
      detailTitle: 'Mission {{id}}',
      retry: 'Retry',
      blockTitle: 'Blocked',
      questionsTitle: 'Questions awaiting answers',
      submitAnswers: 'Submit answers',
      actionTitle: 'Agent action',
      actionOutcome: 'Last outcome',
      actionCapability: 'Capability',
      actionCandidate: 'Change candidate',
      sourcesTitle: 'Requirement sources',
      refreshPreview: 'Check for upstream changes',
      refreshChanged: 'Changed → {{revision}}',
      refreshApply: 'Apply refresh',
      refreshUnchanged: 'Up to date',
      noSources: 'No requirement source generations yet.',
      colGeneration: 'Gen',
      colRevision: 'Revision',
      colState: 'State',
      manifestTitle: 'Requirement bundle',
      noManifest: 'No requirement bundle materialized yet.',
      colFile: 'File',
      colRole: 'Role',
      colBytes: 'Bytes',
      colActions: 'Actions',
      viewFile: 'View',
      effectsTitle: 'Platform effects',
      noEffects: 'No effects recorded yet.',
      colEffect: 'Effect',
      colCreated: 'Created',
      collaborationTitle: 'External collaboration',
      childMissionTitle: 'Called digital employee',
      collaborationPending: 'starting',
      childMissionCreating: 'The child task is being created idempotently.',
      openChildMission: 'Open child task',
      approvalTitle: 'External approval',
      openApproval: 'Open approval request',
      approvalWaiting: 'The platform is waiting for the external approval result.',
      collaborationDeadline: 'Deadline: {{time}}',
      readinessTitle: 'Readiness',
      noReadiness: 'No readiness snapshot yet.',
      handoff: 'Hand off',
      resume: 'Resume automation',
      attachMr: 'Attach MR',
      attachTitle: 'Attach an existing merge request',
      attachHint:
        'The platform verifies the MR against the code host before binding it — repository, branches and current head are read from the host, not from this form.',
      attachMrIid: 'MR number (iid)',
      attachEndpoint: 'Code host',
      attachEndpointAuto: 'Derive from repository',
      attachProject: 'Project path override',
      attachProjectHint: 'Leave empty to derive from the repository binding.',
      attachSubmit: 'Attach',
      configOutdated: 'Policy pinned at r{{pinned}}, r{{published}} published',
      configUpgradeHint:
        'A newer policy revision exists. Configuration upgrade for running missions ships with the migration batch (PR-9); until then this mission keeps its pinned revision.',
      timelineTitle: 'Timeline',
      timelineEmpty: 'No decisions or effects recorded yet.',
      timelineDecision: 'decision',
      timelineEffect: 'effect',
      timelineExpand: 'Trace',
      timelineCollapse: 'Hide',
      evidenceTitle: 'Pipeline evidence',
      evidenceNone: 'No pipeline evidence has been collected for this mission yet.',
      evidenceHead: 'Collected head',
      evidenceCollectedAt: 'Collected at',
      evidenceGatesTitle: 'Gates',
      evidenceFilesTitle: 'Evidence files',
      evidenceNoFiles: 'The evidence bundle contains no files.',
      evidenceUntrusted:
        'External program output — untrusted content. Shown as plain text only; links and markup are never rendered.',
      evidenceLoaded: '{{loaded}} of {{total}} bytes loaded',
      evidenceLoadMore: 'Load more',
      colGate: 'Gate',
      colRun: 'Run',
      status: {
        admitting: 'Checking admission rules',
        'awaiting-information': 'Needs information',
        working: 'Digital employee working',
        publishing: 'Delivering changes',
        watching: 'Watching the merge request',
        'ready-to-merge': 'Ready to merge',
        'waiting-committer': 'Waiting for committer',
        blocked: 'Needs attention',
        'completed-no-change': 'No change confirmed',
        merged: 'Merged',
      ...
      wizard: {
        title: 'Hand work to a digital employee',
        subtitle:
          'Describe the work and confirm its rules and delivery; the platform then develops and watches the merge request through merge.',
        stepRepository: 'Repository & delivery',
        stepRequirement: 'Requirement or issue',
        stepAutomation: 'Employee & rules',
        stepReview: 'Preflight & launch',
        continueTo: 'Next: {{step}}',
        repositoryWhyTitle: 'Confirm the work boundary first',
        repositoryWhyBody:
          'The digital employee edits business files only in an isolated workspace. The platform performs commit, push, merge-request and pipeline operations from rules.',
        deliveryLabel: 'How should the change be delivered?',
        deliveryCreate: 'Create a new merge request',
        deliveryCreateHint:
          'The platform creates the branch and MR, then keeps handling review and pipeline feedback.',
        deliveryAdopt: 'Adopt an existing merge request',
        deliveryAdoptHint: 'Continue from its current head and watch its remaining lifecycle.',
        targetRef: 'Target branch (optional)',
        targetRefHint: 'Leave empty to use the repository default branch.',
        mergeRequestRef: 'Existing MR reference',
        mergeRequestRefHint:
          'Enter the MR number or another reference recognized by the code host.',
        ...
        filesDropTitle: 'Drop requirement attachments or repository files',
        filesDropBody: 'Files are temporary until preflight passes and the mission is launched.',
        filesChoose: 'Choose files',
        fileTarget: 'Repository target path',
        collisionMode: 'If the target exists',
        collisionCreate: 'Create only',
        collisionReplace: 'Replace the exact existing file',
        contentPolicy: 'Digital employee file access',
        contentPreserve: 'Preserve as uploaded',
        contentPreserveHint: 'The Agent may not edit, move or delete this file.',
        contentEditable: 'Allow Agent edits',
        contentEditableHint: 'The Agent may edit content but not delete it or change its mode.',
        executable: 'Commit as executable',
        executableHint:
          'The policy must allow executable mode; preflight makes the final decision.',
        externalInfoTitle: 'An ID is not requirement text',
        externalInfoBody:
          'The platform first downloads the multi-file source through the employee Adapter, then mounts it read-only for the Agent.',
        rulesTitle: 'Rules choose the workflow; AI does not',
        rulesBody:
          'Published policy determines employee selection, action order, retries, pipeline gates and readiness. The Agent only works inside one typed action boundary.',
        employeeAuto: 'Resolve from repository assignment',
        employeeAutoHint: 'Uses deterministic repository → group → global-default priority.',
        employeeExplicit: 'Choose an employee for this mission',
        employeeExplicitHint: 'Pins the exact published employee revision.',
        employeePublished: 'Published digital employee',
        assignmentResolved: 'Resolved from assignment during preflight',
        assignmentHint:
          'Preflight shows the exact employee and policy. Launch is blocked if no assignment resolves.',
        openAssignments: 'View employee assignments',
        policyOverride: 'Execution policy override (optional)',
        policyOverrideHint:
          'Normally use the employee default. Override only when this mission needs different rules.',
        employeeDefaultPolicy: 'Use the employee default policy',
        manageEmployees: 'Manage digital employees',
        managePolicies: 'Manage automation policies',
        reviewRepository: 'Work and delivery',
        reviewRequirement: 'Input',
        reviewAutomation: 'Automation rules',
        preflight: 'Run configuration and file preflight',
        preflightAgain: 'Run preflight again',
        preflightRunning: 'Running preflight…',
        preflightRequiredTitle: 'One preflight remains before launch',
        preflightRequiredBody:
          'The platform resolves employee, policy and requirement source through the launch selector, then validates every upload against the current repository baseline.',
        preflightBlocked: 'The current configuration cannot launch',
        sourceSelectionTitle: 'Choose a requirement source',
        sourceSelectionPlaceholder: 'Choose a bound requirement source…',
        uploadBlockedTitle: 'Some files cannot be committed',
        uploadBlockedBody:
          'Use the table reason to change the path or policy, then run preflight again.',
        preflightReady: 'Rules and file boundaries are confirmed',
        preflightReadyBody:
          'Employee {{employee}} and policy {{policy}} will be pinned; the platform can now keep advancing the mission.',
        uploadPlanTitle: 'File commit plan',
        baselineSha: 'Computed from repository baseline {{sha}}; launch rechecks it atomically.',
        disposition: 'Preflight result',
        dispositionValue: {
          create: 'Create',
          replace: 'Replace',
        ...
        launch: 'Launch and hand off to the digital employee',
      },
      guidance: {
        mergedTitle: 'The mission lifecycle is complete',
        mergedBody:
          'A committer merged the MR. The platform has stopped writing and retained the full mission trail.',
        readyTitle: 'The merge request is ready at any time',
        readyBody:
          'All automation holds are clear. The platform never auto-merges; a committer now reviews and merges it.',
        answersTitle: 'The digital employee needs more information',
        answersBody:
          'Answer the questions below; the platform freezes the answers into the next input and continues automatically.',
        blockedTitle: 'A deterministic condition prevents progress',
        blockedBody:
          'Use the block detail below, fix configuration or external state, then retry. The platform will not guess.',
        handoffTitle: 'A human currently owns the work',
        handoffBody:
          'The platform only tracks lifecycle and no longer writes. Resume automation or attach the MR after confirming external state.',
        watchingTitle: 'The digital employee is watching the merge request',
        watchingBody:
          'The platform keeps collecting review feedback, pipeline gates and head changes, and starts rule-selected repairs.',
        terminalTitle: 'The mission has stopped',
        terminalBody:
          'No more writes will run; the timeline and evidence remain available for review.',
        workingTitle: 'The digital employee is advancing the mission',
        workingBody:
          'The platform is selecting and running the next action from published rules; no manual polling is required.',
        deliveryCreated: 'Platform-created MR',
        deliveryAdopted: 'Adopted MR',
      },
      readiness: {
        automation: 'Automation readiness',
        ready: 'All machine conditions satisfied',
        inProgress: 'Machine conditions still in progress',
        hostMergeable: 'Code-host mergeability',
        head: 'Evaluated head',
        machineHolds: 'Platform work remaining',
        humanHolds: 'Committer work remaining',
        none: 'None',
        advanced: 'Advanced: raw readiness receipt',
        mergeable: { yes: 'Mergeable', no: 'Not mergeable', unknown: 'Not confirmed' },
        hold: {
          'active-action': 'Agent action is still running',
          'unconfirmed-effect': 'Platform effect is not confirmed',
          'unhandled-feedback': 'Review feedback remains',
          conflict: 'Conflict with the target branch',
          'required-gate-not-pass': 'A required pipeline gate has not passed',
          'facts-incomplete': 'External facts are incomplete',
          'head-mismatch': 'Evidence belongs to an older head',
          'upload-fulfillment-pending': 'Uploaded files are not published yet',
          'approval-required': 'Approval is still required',
          'thread-unresolved': 'A human review thread is unresolved',
          'committer-policy-hold': 'Policy requires final committer confirmation',
        },
      },
    },
    policies: {
      title: 'Automation policies',
      subtitle: 'First-match rules, budgets and delivery settings that drive digital employees',
      backToCode: '\u2190 Code',
      backToList: '\u2190 Policies',
      create: 'New policy',
      createTitle: 'Create an automation policy',
      createHint:
        'The policy starts from the platform default template; edit and publish it to use.',
      nameLabel: 'Name',
      namePlaceholder: 'e.g. java-service-default',
      emptyTitle: 'No policies yet',
      emptyBody: 'Create one to configure how digital employees pick and run actions.',
      colName: 'Name',
      ...
      saved: 'Saved',
      publish: 'Publish',
      publishNeedsSave: 'Save the draft before publishing',
      neverPublished: 'Never published \u2014 missions cannot pin this policy yet.',
      publishedAt: 'Published revision {{n}}. Running missions keep the revision they pinned.',
      violationsTitle: 'Publish blocked',
      tabRules: 'Rules',
      tabSettings: 'Settings',
      tabSimulate: 'Simulate',
      tabsLabel: 'Policy sections',
      fixedGuardsTitle: 'Fixed guards (read-only)',
      fixedGuardsHint:
        'Guards run before every rule, in this exact order. They are product invariants and cannot be configured.',
      actionRulesTitle: 'Action priority (first match wins)',
      selectionRulesTitle: 'Employee selection rules',
      selectionRulesHint: 'Optional; used when the repository assignment selects by rules.',
      firstMatchHint:
        'Rules are evaluated top-down; the first rule whose predicates all hold wins.',
      ...
      moveUp: 'Move up',
      moveDown: 'Move down',
      predicatesN: '{{n}} predicate(s)',
      removeRule: 'Remove rule',
      addRule: 'Add rule',
      addPredicate: 'Add predicate',
      removePredicate: 'Remove predicate',
      predicateKind: 'Predicate kind',
      predicateFact: 'Fact',
      predicateValue: 'Value',
      predicateOp: 'Comparison',
      predicateValuesPlaceholder: 'Add a value\u2026',
      predicateJson: 'Composite predicate (JSON)',
      predicateJsonHint: 'all / any / not composites are edited as raw JSON.',
      predicateJsonError: 'Rule {{rule}}: invalid predicate JSON',
      requirementJson: 'Requirement section (JSON)',
      requirementJsonHint:
        'The requirement / upload section is deeply nested; it is edited as raw JSON here.',
      requirementJsonError: 'Requirement section: invalid JSON',
      secAdmission: 'Admission',
      admissionDirect: 'Allow direct submissions',
      admissionExternal: 'Allow external requirement ids',
      admissionDuplicate: 'Duplicate external id',
      secFeedback: 'Feedback',
      feedbackClass: 'Handle {{cls}} feedback',
      feedbackBatch: 'Batch limit',
      feedbackLatest: 'Only latest thread revision',
      secPipeline: 'Pipeline gates',
      pipelineStale: 'Evidence stale after (ms)',
      gateKey: 'Gate key',
      gateRequired: 'Required',
      gateDisposition: 'Missing run',
      gateCategories: 'Rerunnable categories',
      gateMaxReruns: 'Max reruns',
      gateRemove: 'Remove gate',
      gateAdd: 'Add gate',
      secConflict: 'Conflict',
      conflictMode: 'Mode',
      conflictAttempts: 'Max repair attempts',
      secDelivery: 'Delivery',
      deliveryPrefix: 'Source branch prefix',
      deliveryCollision: 'Branch collision',
      deliveryDraft: 'Open MRs as draft',
      deliveryHumanPush: 'On human push to source branch',
      secVerification: 'Verification',
      verificationProfiles: 'Required verification profiles',
      verificationProfilesHint: 'profile-id@revision; all must pass before publishing a candidate.',
      verificationStop: 'Stop policy',
      secRetry: 'Retries & budgets',
      retry_sameSessionRetries: 'Same-session retries',
      retry_freshSessionReruns: 'Fresh-session reruns',
      retry_actionRunsPerMission: 'Action runs per mission',
      retry_commitsPerMission: 'Commits per mission',
      retry_missionWallTimeMs: 'Mission wall time (ms)',
      secReadiness: 'Readiness',
      readinessGates: 'Additional required gate keys',
      readinessFeedback: 'Unresolved feedback blocks ready',
      secNotification: 'Notification',
      notificationOverview: 'MR overview comment',
      notificationEscalation: 'Escalation interval (ms)',
      secRetention: 'Retention',
      retention_requirementBundleTerminalTtlDays: 'Requirement bundle TTL (days)',
      retention_pipelineBundleTerminalTtlDays: 'Pipeline bundle TTL (days)',
      retention_attemptLedgerTtlDays: 'Attempt ledger TTL (days)',
      secRequirement: 'Requirement & uploads',
      simGuards: 'Guard fixture',
      simGuardTerminal: 'Mission terminal',
      simGuardActiveAction: 'Writable action running',
      simGuardUnsettled: 'Unsettled effect',
      simGuardMrTerminal: 'MR terminal state',
      simGuardMode: 'Automation mode',
      simGuardUploadSeed: 'Upload seed state',
      simCells: 'Fact fixture',
      simCellsHint:
        'Facts not listed here are indeterminate \u2014 rules reading them will honestly stop.',
      simCellFact: 'Fact',
      simCellValue: 'Value',
      simCellValuePlaceholder: 'value (sets: comma-separated)',
      simCellRemove: 'Remove fact',
      simCellAdd: 'Add fact',
      simRun: 'Run simulation',
      simSelected: 'Selected decision',
      simNoMatch: 'no-match',
      simNoMatchHint:
        'Guards all passed but no rule matched \u2014 in production the mission would block on no-policy-match.',
      simGuardTrace: 'Guard trace',
      simRuleTrace: 'Rule trace',
      simRuleTraceEmpty: 'Guards stopped evaluation before any rule ran.',
      simMatched: 'matched',
      simMissed: 'miss',
      simSelectionTitle: 'Employee selection preview',
      simSelectionEmployee: 'Explicit employee ref',
      simSelectionRun: 'Preview selection',
    },
    flow: {
      capability: 'Capability',
    ...
    bulk: {
      open: 'Change many repositories',
      title: 'Apply one capability change across repositories',
      repos: 'Repositories',
      reposHint:
      ...
      preview: 'Preview',
      apply: 'Apply',
      undo_one: 'Undo ({{count}} repository)',
      undo_other: 'Undo ({{count}} repositories)',
      failures_one: '{{count}} failed',
      failures_other: '{{count}} failed',
    },
  ...
  reviewers: {
    entry: 'Configure reviewers',
    title: 'Reviewers by review node',
    backToTask: 'Back to task',
    capabilityNotice:
      'Reviewers can read documents and all comments for assigned nodes, and add or edit their own pending comments. They cannot delete comments, approve, regenerate, reject, or select documents.',
    emptyTitle: 'This task has no review nodes',
    emptyDescription: 'The frozen task workflow has no review nodes to configure.',
    nodeReviewers: 'Reviewers',
    nodeHint:
      'Select any number of people per node. Saving fully replaces reviewer sets for every review node in this task.',
    pickerPlaceholder: 'Search and add reviewers…',
    pickerAria: 'Select reviewers for {{node}}',
    strongerRoleHint:
      'Some selected users are also task owners or collaborators; they retain their existing approve, regenerate, and reject capabilities.',
    replaceHint: 'Saving immediately replaces the complete reviewer configuration.',
    saved: 'Reviewer configuration saved.',
    relationship: {
      owner: 'Owner',
  ...
  settings: {
    ...
    sectionDescriptions: {
      ...
      database: 'Inspect the live provider and migrate SQLite to external PostgreSQL.',
    ...
    database: {
      ...
      sourceSize: 'Retained SQLite source',
      sourceUnavailable: 'Not retained or unavailable',
      unavailable: 'Unavailable',
      rows: 'rows',
      rowsUnknown: 'row count available after preflight',
      ...
      fixFields: 'Fix every invalid target field shown above.',
      preflightRequired: 'Test this exact target profile successfully before starting migration.',
      preflightReady: 'Target preflight passed',
      testing: 'Testing…',
      testConnection: 'Test target',
      ...
      bytesCopied: 'Artifact bytes',
      tablePlan: 'Table plan',
      rollbackStatus: 'Rollback boundary',
      rollbackReasons: {
    ...
    cardGroups: {
      ...
      maintenanceTitle: 'Background maintenance',
      maintenanceHint:
        'Heavy cleanup runs serially in an isolated Worker, so database and file maintenance no longer occupies the request-serving event loop.',
    ...
    maintenance: {
      modeLabel: 'Heavy-cleanup schedule',
      modeHint:
        'This controls cleanup only. Correctness recovery and WAL maintenance keep their own cadence.',
      hourly: 'Hourly, staggered',
      daily: 'Once daily',
      timeLabel: 'Start time (24-hour)',
      timeHint:
        'Use HH:MM, for example 02:00. This is a start time; a large backlog may continue afterward.',
      timeError: 'Enter a valid 24-hour time as HH:MM (00:00–23:59).',
      timezoneLabel: 'IANA timezone',
      timezoneHint: 'Use an IANA name such as Asia/Shanghai or America/New_York.',
      timezoneError: 'Enter a valid IANA timezone, for example Asia/Shanghai.',
      statusLoading: 'Loading maintenance status…',
      statusError: 'Maintenance status could not be loaded.',
      workerLabel: 'Worker',
      nextRunLabel: 'Next cleanup start',
      activeLabel: 'Running now',
      lastLabel: 'Most recent run',
      progressLabel: 'Progress',
      backlogLabel: 'Backlog',
      notScheduled: 'Not scheduled',
      noActive: 'Idle',
      neverRun: 'No completed run yet',
      noProgress: 'No counters reported yet',
      noBacklog: 'Nothing waiting',
      backlogCount: '{{count}} waiting or failed',
      jobAt: '{{job}} · started {{time}}',
      lastAt: '{{job}} · {{outcome}} · {{time}}',
      workerError: 'Maintenance Worker degraded',
      lastError: 'Most recent maintenance error',
      worker: {
        starting: 'Starting',
        ready: 'Ready',
        degraded: 'Degraded',
      ...
      jobs: {
        worktreeGc: 'Worktree cleanup',
        webhookDeliveryGc: 'Webhook delivery cleanup',
        eventsArchive: 'Event archive',
        retentionSweep: 'Retention cleanup',
        taskArchive: 'Settled-task archive',
        backupPrune: 'Backup cleanup',
        pluginGenerationGc: 'Plugin generation cleanup',
        developmentUploadGc: 'Development upload cleanup',
        developmentRetentionSweep: 'Development retention cleanup',
        employeeInputGc: 'Employee input cleanup',
        intentScratchGc: 'Intent scratch cleanup',
        tokenAuditGc: 'Token audit cleanup',
        workspaceRecovery: 'Workspace cleanup recovery',
        intentRecovery: 'Intent recovery',
        lifecycleInvariants: 'Lifecycle invariant check',
        stuckTaskDetector: 'Stuck-task detection',
        humanGateRecovery: 'Human-gate recovery',
  ...
  taskWizard: {
    ...
    draftRecoveryTitle: 'Continue filling out your previous task?',
    draftRecoveryBody:
      'You entered task details here but did not create the task. Continue to restore the details below, or start over to clear the draft.',
    draftRecoveryUnknownBody:
      'The page did not receive a definite result after your last submission. The task may already exist; continue by checking the task list to avoid creating a duplicate.',
    draftRecoveryObject: 'Execution object',
    draftRecoveryTaskName: 'Task content',
    draftRecoverySavedAt: 'Saved',
    draftRecoveryNotSelected: 'Not selected yet',
    draftRecoveryNotNamed: 'Not entered yet',
    draftRestore: 'Continue filling out',
    draftDiscard: 'Start over',
    draftRestoreUnknown: 'Restore and check result',
    draftDiscardUnknown: 'No check needed; delete record',
