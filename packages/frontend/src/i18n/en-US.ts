...
export const enUS: Resources = {
  ...
  nav: {
    ...
    webhooks: 'Webhooks',
    code: 'Code',
    digitalEmployees: 'Capability design',
    executors: 'Executor library',
    employeeAssignments: 'Repository scope',
    employeeOutcomes: 'Run outcomes',
    settings: 'Settings',
  ...
  code: {
    ...
    outcomes: {
      title: 'Run outcomes',
      employeeTitle: '{{employee}} outcomes',
      subtitle:
        'Historical mission results and capability signals for tuning employees and policies.',
      backToCode: '← Digital employees',
      backToTasks: '← Digital employee tasks',
      showAll: 'Show all employees',
      historyTitle: 'Mission outcome history',
      historyHint: 'Terminal results stay here; live work remains in the unified task list.',
      emptyTitle: 'No completed missions yet',
      emptyBody: 'Results appear after a mission reaches a terminal lifecycle state.',
      colMission: 'Mission',
      colResult: 'Result',
      colEmployee: 'Digital employee',
      colRepository: 'Repository',
      colCompleted: 'Completed',
      employeeFallback: 'Repository-assigned employee',
      summaryAria: 'Mission outcome summary',
      summary: {
        merged: { title: 'Merged', body: 'A committer accepted and merged the prepared MR.' },
        noChange: {
          title: 'No change needed',
          body: 'The requirement was already satisfied and confirmed.',
        },
        closed: { title: 'Closed', body: 'Stopped or closed without a merged change.' },
        failed: { title: 'Failed', body: 'Reached a terminal failure that needs process tuning.' },
      },
      capabilityTitle: 'Capability outcome signals',
      employeeSummaryTitle: 'This employee’s mission outcomes',
      employeeSummaryOpen: 'Open outcomes',
      employeeSummaryHint: 'Live load and terminal results generated by this published employee.',
      employeeActive: ' active',
      employeeReady: ' merge-ready',
      employeeDelivered: ' delivered',
    },
    tab: {
      matrix: 'Repositories',
      activity: 'Activity',
  ...
  tasks: {
    ...
    operations: {
      ...
      digitalEmployeeTask: 'Digital employee task',
      digitalEmployeeOwner: 'Digital employee',
      applyFilters: 'Apply filters',
