...
export const enUS: Resources = {
  nav: {
    ...
    inbox: {
      ...
      suspensionItemSubtitle: 'task {{taskId}} · node {{nodeId}}',
      suspensionKindSelfClarify: 'Self-clarify',
      suspensionKindCrossClarify: 'Cross-clarify',
      suspensionKindReview: 'Review',
      suspensionKindRetryAuto: 'Retry (auto)',
      suspensionKindRetryHuman: 'Retry (manual)',
      suspensionKindAwaitExternal: 'External data',
    },
    memory: 'Memory',
  ...
  suspensions: {
    ...
    taskHint: 'task {{id}}…',
    nodeHint: 'node {{id}}',
    alreadyResolved: 'This item has been resolved; the form below is read-only.',
    submitAnswers: 'Submit answers',
    submitDecision: 'Submit decision',
    noQuestions: 'No questions found — may have been answered elsewhere.',
    crossClarifyDesignerHint: 'Question target',
    crossClarifyDesignerValue: 'Questioner {{questioner}} → designer {{designer}}',
    crossClarifyDirective: 'Decision',
    crossClarifyDirective_submit: 'Submit answers (designer re-runs)',
    crossClarifyDirective_reject: 'Reject (ask questioner to rewrite)',
    crossClarifyDirective_stop: 'Stop the clarify loop',
    rejectionFeedback: 'Rejection feedback (required)',
    reviewHint: 'Reviewer hint',
    reviewDocument: 'Document under review (node {{node}} · port {{port}})',
    reviewDecision: 'Decision',
    reviewDecision_approve: 'Approve',
    reviewDecision_iterate: 'Iterate (ask designer to revise)',
    reviewDecision_reject: 'Reject',
    reviewComments: 'Comments (required)',
    reviewSummary: 'Summary (optional)',
    retryHumanHint: 'Auto-retry budget exhausted. Manual confirmation needed to try again.',
    retryNow: 'Retry now',
    retryAutoNote: 'Handled by the scheduler; no manual action needed.',
    awaitExternalNote: 'Waiting on external data; v1 has no ingress wired yet.',
  },
  memory: {
