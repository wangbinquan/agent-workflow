...
export const enUS: Resources = {
  ...
  settings: {
    webhookEndpoints: {
      ...
      add: 'New endpoint',
      hint: 'Create a stable event entrance for GitLab, then paste its URL and secret into the GitLab webhook.',
      empty: 'No ingress endpoints yet',
      emptyDescription:
        'Create an endpoint, save its one-time secret, then finish the connection in GitLab.',
      enabled: 'Enabled',
      disabled: 'Disabled',
      ...
      rotateConfirmDescription:
        'The old secret for “{{name}}” will stop working immediately. Update GitLab with the new secret right away or every later delivery will fail verification.',
      rotateConfirmAction: 'Rotate secret',
      deleteConfirm: 'Confirm delete?',
      addTitle: 'New webhook endpoint',
      nameLabel: 'Name',
      namePlaceholder: 'Internal GitLab',
      ...
      secretOnce:
        'This secret is shown only once. Copy it now and paste it into the Secret token field of the GitLab webhook.',
      secretLabel: 'Secret token',
      copySecret: 'Copy',
      secretCopied: 'Copied',
      urlLabel: 'Webhook URL',
      secretPasteHint: 'In GitLab: Settings → Webhooks — paste the URL and secret token together.',
    },
    customProviders: {
  ...
  webhookTriggers: {
    ...
    firesButton: 'Fires',
    deleteConfirm: 'Confirm delete?',
    dialogCreate: 'New trigger',
    dialogEdit: 'Edit trigger',
