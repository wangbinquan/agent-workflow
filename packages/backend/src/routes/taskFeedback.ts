...
//
// Both endpoints 404 for a missing task AND for a task the caller cannot see
// (canViewTask) — RFC-285 B1 made the two byte-identical (pre-B1 the invisible
// branch was a 403, which leaked task existence). POST returns the persisted
