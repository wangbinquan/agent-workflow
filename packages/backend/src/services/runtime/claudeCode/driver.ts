...
export function renderClaudeInjection(spec: AgentInjectionSpecV1): RenderedInjectionV1 {
  ...
  declared.droppedParams = spec.profile === undefined ? [] : deriveClaudeDroppedParams(spec.profile)
...
export async function assembleClaudePersonaSpawn(ctx: SystemAgentSpawnContext): Promise<SpawnPlan> {
...
export async function assembleClaudeBusinessSpawn(
