...
//
// Digital-employee attempts materialize requirement and pipeline evidence under
// `.agent-workflow/`, which is intentionally Git-ignored. Agent nodes execute in
// RFC-130 isolated worktrees, so the task engine needs a durable, launch-frozen
