// RFC-349 compatibility adapter and stored-closure codec. New launches freeze
// through TaskExecutionResourceBinding; the SQLite walk remains as an exact
// behavior oracle for historical focused tests.
//
