 ...
 */
function deferralApplies(input: PostgresqlTaskWorkspacePreparation): boolean {
...
async function prepareDeferredWorkspace(
  ...
  input: PostgresqlTaskWorkspacePreparation,
  ...
  return Object.freeze({
    ...
    earlyError: null,
    repositories: [] as readonly PostgresqlTaskRouteWorkspaceRepository[],
