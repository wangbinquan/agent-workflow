...
import { discloseRefs } from '@/modules/resource-catalog/composition/resourceAcl'
...
export async function deleteSkill(
  ...
  if (expected !== undefined) {
    const { decodeSkillToken } =
      await import('@/modules/resource-catalog/infrastructure/legacy/skillToken')
...
export async function saveSkillWithToken(
  ...
  const { decodeSkillToken, skillTokenMatches } =
    await import('@/modules/resource-catalog/infrastructure/legacy/skillToken')
