...
import { WG_LEADER_NODE_ID } from '@/modules/resource-catalog/infrastructure/legacy/workgroup/constants'
import {
...
import { buildRoomMessageRow } from '@/modules/resource-catalog/infrastructure/legacy/workgroup/messages'
import { resolveRoomMessageRound } from '@/modules/resource-catalog/infrastructure/legacy/workgroup/rounds'
...
export interface WorkgroupTaskActionDeps {
  db: DbClient
  configPath: string
  schedulerDriver: Parameters<typeof resumeTask>[2]['schedulerDriver']
...
export function buildWorkgroupTaskActions(deps: WorkgroupTaskActionDeps) {
  function buildResumeDeps(): Parameters<typeof resumeTask>[2] {
    return {
      ...
      taskRecoveryOperations: deps.taskRecoveryOperations,
      appHome: Paths.root,
