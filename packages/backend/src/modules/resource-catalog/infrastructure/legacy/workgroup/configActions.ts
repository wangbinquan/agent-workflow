...
import { broadcastWg } from '@/modules/resource-catalog/infrastructure/legacy/workgroup/taskActions'
import type { buildWorkgroupTaskActions } from '@/modules/resource-catalog/infrastructure/legacy/workgroup/taskActions'
