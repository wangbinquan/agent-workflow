...
} from '@/modules/resource-catalog/infrastructure/legacy/workgroup/lifecycle'
import {
  ...
  type WakeInput,
  type WakeItem,
} from '@/modules/resource-catalog/infrastructure/legacy/workgroup/wake'
import {
  WG_LEADER_NODE_ID,
  WG_MEMBER_NODE_ID,
...
} from '@/modules/resource-catalog/infrastructure/legacy/workgroup/hooks'
import type { WorkgroupEngineHooks } from '@/modules/resource-catalog/infrastructure/legacy/workgroup/hooks'
...
export {
  followupForFailure,
  wgFollowupNotice,
} from '@/modules/resource-catalog/infrastructure/legacy/workgroup/turnExecution'
import {
  loadDbState,
  type EngineDbState,
} from '@/modules/resource-catalog/infrastructure/legacy/workgroup/state'
...
import {
  ...
  openCompletionGate,
  warnIfZeroDeltaDone,
} from '@/modules/resource-catalog/infrastructure/legacy/workgroup/strategies/leaderWorker'
import { driveBatchTurn } from '@/modules/resource-catalog/infrastructure/legacy/workgroup/strategies/freeCollab'
import {
  driveAssignmentTurn,
  driveMessageTurn,
} from '@/modules/resource-catalog/infrastructure/legacy/workgroup/memberTurns'
import { settleCardAfterFailure } from '@/modules/resource-catalog/infrastructure/legacy/workgroup/lifecycle'
import {
  countBudgetUsed,
  roundMode,
...
// RFC-209 — 推导本体搬到本域 workgroup/rounds.ts（回合账本单一事实源），
