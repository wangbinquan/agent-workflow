...
import {
  persistWgMessages,
  postMessage,
} from '@/modules/resource-catalog/infrastructure/legacy/workgroup/messages'
import { composeLeaderPrompt } from '@/modules/resource-catalog/infrastructure/legacy/workgroup/prompts'
import type { WorkgroupEngineArgs } from '@/modules/resource-catalog/infrastructure/legacy/workgroup/engine'
...
import { resolveMemberAgent } from '@/modules/resource-catalog/infrastructure/legacy/workgroup/memberTurns'
import { hasSalvageableWork } from '@/modules/resource-catalog/infrastructure/legacy/workgroup/wake'
