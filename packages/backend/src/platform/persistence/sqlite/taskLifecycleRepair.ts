// RFC-057 — Diagnose Panel repair option engine (SQLite provider adapter).
//
...
import { C1_OPTIONS } from './taskLifecycleRepair/options-C1'
import { CR1_OPTIONS } from './taskLifecycleRepair/options-CR1'
import { R1_OPTIONS } from './taskLifecycleRepair/options-R1'
import { R2_OPTIONS } from './taskLifecycleRepair/options-R2'
import { S1_OPTIONS } from './taskLifecycleRepair/options-S1'
import { S2_OPTIONS } from './taskLifecycleRepair/options-S2'
import { S3_OPTIONS } from './taskLifecycleRepair/options-S3'
import { S4_OPTIONS } from './taskLifecycleRepair/options-S4'
import { S5_OPTIONS } from './taskLifecycleRepair/options-S5'
import { S6_OPTIONS } from './taskLifecycleRepair/options-S6'
import { T1_OPTIONS } from './taskLifecycleRepair/options-T1'
import { T2_OPTIONS } from './taskLifecycleRepair/options-T2'
import { T3_OPTIONS } from './taskLifecycleRepair/options-T3'
import { U1_OPTIONS } from './taskLifecycleRepair/options-U1'
import type {
  ApplyResult,
  ...
  RepairOptionDef,
  RepairTaskRow,
} from './taskLifecycleRepair/types'
