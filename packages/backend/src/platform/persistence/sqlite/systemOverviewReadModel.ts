...
// System Operations SQLite overview read-model adapter. The compatibility export
// does not expose the provider mechanism.
...
async function buildOverviewFresh(
  ...
  const [
    ...
    gatedCount(actor, 'repos:read', () => repositories.countCachedRepositories()),
