...
export const ENDPOINTS: EndpointSpec[] = [
  ...
  { method: 'POST', path: '/api/code/missions/preview' },
  ...
  { method: 'POST', path: '/api/code/missions/:id/handoff' },
  { method: 'POST', path: '/api/code/missions/:id/attach-mr' },
  ...
  { method: 'GET', path: '/api/execution-contracts' },
  { method: 'GET', path: '/api/execution-contracts/:contractRef' },
  { method: 'POST', path: '/api/execution-contracts/:contractRef/agent-candidates' },
  ...
  { method: 'GET', path: '/api/digital-employee-types/:typeRef/upgrade-candidates' },
  ...
  { method: 'POST', path: '/api/digital-employee-types/:typeRef/employees/:id/upgrade' },
  { method: 'GET', path: '/api/digital-employees' },
  { method: 'GET', path: '/api/digital-employees/launchable' },
  ...
  },
  {
    ...
    happy: {
      ...
      schema: TaskCatalogPageSchema,
    },
  },
  {
    method: 'GET',
    path: '/api/task-catalog/sources',
    happy: { schema: TaskCatalogSourcesDocumentSchema },
  },
  {
    method: 'GET',
    path: '/api/tasks/:id',
