...
export const COVERAGE_PARITY_LEDGER: readonly string[] = [
  'modules/intent/infrastructure/IntentApplyArtifactLifecycle: sqlite 3/1, postgresql 5/4',
  ...
  'modules/intent/infrastructure/IntentApplyOperations: sqlite 21/3, postgresql 6/4',
...
export const INVERTED_PAIRS: readonly string[] = [
  ...
  'modules/intent/infrastructure/IntentApplyOperations: 21 vs 6',
