...
const TASK_INSERT_SITES: readonly string[] = [
  ...
  'modules/task-execution/infrastructure/taskRouteLaunchOperations.ts:852 executionLineageId+ lineageSlotPathJson+ launchOrigin+',
  ...
  // RFC-359 AC-1（plan §5hn 之后的盘点，第 2 / 3 刀）：3590 → 3580 → 3567。站点与它写的
  ...
  'services/task.ts:2432 executionLineageId+ lineageSlotPathJson+ launchOrigin+',
]
