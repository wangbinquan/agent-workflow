...
const TASK_INSERT_SITES: readonly string[] = [
  ...
  'modules/task-execution/infrastructure/taskRouteLaunchOperations.ts:843 executionLineageId+ lineageSlotPathJson+ launchOrigin+',
  ...
  'services/task.ts:2437 executionLineageId+ lineageSlotPathJson+ launchOrigin+',
]
