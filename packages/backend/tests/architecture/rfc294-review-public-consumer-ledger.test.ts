...
export const UNCONSUMED_PUBLIC_SYMBOL_DEBT: readonly Debt[] = [
  ...
  { id: 'public:resource-catalog:queries:ResourceCatalogQuery', removeAfterWave: 'W4-C' },
  { id: 'public:resource-catalog:types:ACL_CATALOG_KINDS', removeAfterWave: 'W4-C' },
  { id: 'public:resource-catalog:types:CATALOG_SELECTOR_KINDS', removeAfterWave: 'W4-C' },
  { id: 'public:resource-catalog:types:FrozenIntegrationTriggerResourceSnapshot', removeAfterWave: 'W4-C' },
  { id: 'public:resource-catalog:types:FrozenTaskExecutionResourceSnapshot', removeAfterWave: 'W4-C' },
  { id: 'public:resource-catalog:types:GRANT_TARGET_KINDS', removeAfterWave: 'W4-C' },
  { id: 'public:resource-catalog:types:GrantTargetRef', removeAfterWave: 'W4-C' },
  { id: 'public:resource-catalog:types:IntegrationTriggerResourceRequest', removeAfterWave: 'W4-C' },
  { id: 'public:resource-catalog:types:PACKAGE_RESOURCE_KINDS', removeAfterWave: 'W4-C' },
  { id: 'public:resource-catalog:types:PackageResourceKind', removeAfterWave: 'W4-C' },
  { id: 'public:resource-catalog:types:PackageResourceRef', removeAfterWave: 'W4-C' },
  { id: 'public:resource-catalog:types:ResourceSummaryRevisionByKind', removeAfterWave: 'W4-C' },
  { id: 'public:resource-catalog:types:TaskExecutionMcpSnapshot', removeAfterWave: 'W4-C' },
  { id: 'public:resource-catalog:types:TaskExecutionPluginSnapshot', removeAfterWave: 'W4-C' },
  { id: 'public:resource-catalog:types:TaskExecutionResourceRequest', removeAfterWave: 'W4-C' },
  { id: 'public:resource-catalog:types:TaskExecutionSkillSnapshot', removeAfterWave: 'W4-C' },
  { id: 'public:resource-catalog:types:asAclCatalogKind', removeAfterWave: 'W4-C' },
  { id: 'public:resource-catalog:types:asCatalogSelectorKind', removeAfterWave: 'W4-C' },
  { id: 'public:resource-catalog:types:resourceRef', removeAfterWave: 'W4-C' },
  { id: 'public:resource-catalog:types:resourceSummaryRevisionEquals', removeAfterWave: 'W4-C' },
