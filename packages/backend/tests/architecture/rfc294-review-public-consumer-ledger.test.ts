...
export const UNCONSUMED_PUBLIC_SYMBOL_DEBT: readonly Debt[] = [
  ...
  { id: 'public:collaboration:commands:createManualQuestionOpen', removeAfterWave: 'W4' },
  { id: 'public:collaboration:commands:deriveHumanGateCompatibilityKey', removeAfterWave: 'W4' },
  { id: 'public:collaboration:commands:dispatchTaskQuestions', removeAfterWave: 'W4' },
  { id: 'public:collaboration:commands:encodeGateDecisionReceipt', removeAfterWave: 'W4' },
  { id: 'public:collaboration:commands:finalizeCommittedHumanGate', removeAfterWave: 'W4' },
  { id: 'public:collaboration:commands:gateDecisionReceipt', removeAfterWave: 'W4' },
  { id: 'public:collaboration:commands:prepareClarifyGateOpen', removeAfterWave: 'W4' },
  { id: 'public:collaboration:commands:prepareReviewGateOpen', removeAfterWave: 'W4' },
  { id: 'public:collaboration:commands:preparedHumanGateRef', removeAfterWave: 'W4' },
  { id: 'public:collaboration:commands:submitClarifyDecision', removeAfterWave: 'W4' },
  ...
  { id: 'public:collaboration:queries:createReviewAnchorBudget', removeAfterWave: 'W4' },
  ...
  { id: 'public:collaboration:queries:visibleCollaborationTaskIds', removeAfterWave: 'W4' },
  { id: 'public:collaboration:types:ClarifyDecisionCommandPort', removeAfterWave: 'W4' },
  { id: 'public:collaboration:types:QuestionDispatchCommandPort', removeAfterWave: 'W4' },
...
export const DEAD_REQUIRED_PORT_DEBT: readonly DeadPortDebt[] = [
  // RFC-368 T7（2026-09-23）：**销账**——`ReactionExecutionPortV1` 有了 provider
  // （TE 的 `application/adapters/reaction-execution-adapter.ts`），不再是死声明。
  {
