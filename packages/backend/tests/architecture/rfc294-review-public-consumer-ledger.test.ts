...
// `architecture/public-surfaces.json` 405 个 public symbol 里 207 个零 consumer；
...
export const UNCONSUMED_PUBLIC_SYMBOL_DEBT: readonly Debt[] = [
  ...
  { id: 'public:code-capability:queries:CodeMatrixQuery', removeAfterWave: 'W4-E8' },
  { id: 'public:code-capability:queries:CodeMatrixRow', removeAfterWave: 'W4-E8' },
  { id: 'public:code-capability:queries:CodeMetricsQuery', removeAfterWave: 'W4-E8' },
  { id: 'public:code-capability:queries:CodeMetricsSummary', removeAfterWave: 'W4-E8' },
  { id: 'public:code-capability:queries:CodeRepairAction', removeAfterWave: 'W4-E8' },
  { id: 'public:code-capability:queries:CodeRoundAttemptsQuery', removeAfterWave: 'W4-E8' },
  ...
  { id: 'public:code-capability:queries:CodeWorkItemFilter', removeAfterWave: 'W4-E8' },
  { id: 'public:code-capability:queries:CodeWorkItemPage', removeAfterWave: 'W4-E8' },
  { id: 'public:code-capability:queries:CodeWorkItemProjection', removeAfterWave: 'W4-E8' },
  { id: 'public:code-capability:queries:CodeWorkItemProjectionQuery', removeAfterWave: 'W4-E8' },
  ...
  { id: 'public:code-capability:queries:StageGraphNodeKind', removeAfterWave: 'W4-E8' },
  { id: 'public:collaboration:commands:ClarifyGateOpenReceipt', removeAfterWave: 'W4' },
  { id: 'public:collaboration:commands:ManualQuestionOpenReceipt', removeAfterWave: 'W4' },
  { id: 'public:collaboration:commands:ReviewGateOpenReceipt', removeAfterWave: 'W4' },
  ...
  { id: 'public:collaboration:types:ClarifyGateDirective', removeAfterWave: 'W4' },
  { id: 'public:collaboration:types:DispatchTaskQuestionsCommandInput', removeAfterWave: 'W4' },
  { id: 'public:collaboration:types:DispatchTaskQuestionsCommandResult', removeAfterWave: 'W4' },
  { id: 'public:collaboration:types:HumanGateKind', removeAfterWave: 'W4' },
  { id: 'public:collaboration:types:HumanGateRequestPayload', removeAfterWave: 'W4' },
  ...
  { id: 'public:collaboration:types:ReviewActor', removeAfterWave: 'W4' },
  { id: 'public:collaboration:types:ReviewActorUser', removeAfterWave: 'W4' },
  { id: 'public:collaboration:types:ReviewAnchorBlock', removeAfterWave: 'W4' },
  { id: 'public:collaboration:types:ReviewAnchorBlockKind', removeAfterWave: 'W4' },
  { id: 'public:collaboration:types:ReviewAnchorBudget', removeAfterWave: 'W4' },
  { id: 'public:collaboration:types:ReviewAnchorCandidate', removeAfterWave: 'W4' },
  { id: 'public:collaboration:types:ReviewAnchorDocument', removeAfterWave: 'W4' },
  { id: 'public:collaboration:types:ReviewAnchorErrorCode', removeAfterWave: 'W4' },
  { id: 'public:collaboration:types:ReviewAnchorHeading', removeAfterWave: 'W4' },
  { id: 'public:collaboration:types:ReviewAnchorRequest', removeAfterWave: 'W4' },
  { id: 'public:collaboration:types:ReviewAnchorResolution', removeAfterWave: 'W4' },
  { id: 'public:collaboration:types:ReviewAnchorSpan', removeAfterWave: 'W4' },
  { id: 'public:collaboration:types:ReviewAnchorSuccess', removeAfterWave: 'W4' },
  { id: 'public:collaboration:types:ReviewAnchorSuggestion', removeAfterWave: 'W4' },
  { id: 'public:collaboration:types:ReviewAnchorWarning', removeAfterWave: 'W4' },
  { id: 'public:collaboration:types:ReviewGateDecision', removeAfterWave: 'W4' },
  { id: 'public:collaboration:types:SubmitClarifyDecisionCommandInput', removeAfterWave: 'W4' },
  { id: 'public:collaboration:types:SubmitClarifyDecisionCommandResult', removeAfterWave: 'W4' },
  { id: 'public:collaboration:types:SubmitReviewDecisionCommandInput', removeAfterWave: 'W4' },
  { id: 'public:collaboration:types:SubmitReviewDecisionCommandResult', removeAfterWave: 'W4' },
  { id: 'public:development-automation:commands:DevelopmentRetentionSweepResult', removeAfterWave: 'W4-E8' },
  ...
  { id: 'public:digital-employee:commands:DigitalEmployeeAuthoringCommand', removeAfterWave: 'W4-E9' },
  ...
  { id: 'public:digital-employee:queries:DigitalEmployeeAuthoringQuery', removeAfterWave: 'W4-E9' },
  { id: 'public:digital-employee:queries:DigitalEmployeeAuthoringQueryResult', removeAfterWave: 'W4-E9' },
  ...
  { id: 'public:digital-employee:types:DigitalEmployeeProjectionDocument', removeAfterWave: 'W4-E9' },
  { id: 'public:digital-employee:types:DigitalEmployeeProjectionPage', removeAfterWave: 'W4-E9' },
  { id: 'public:digital-employee:types:DigitalEmployeeResourceReceipt', removeAfterWave: 'W4-E9' },
  { id: 'public:digital-employee:types:EMPLOYEE_CASE_TERMINAL_KINDS', removeAfterWave: 'W4-E9' },
  { id: 'public:digital-employee:types:EmployeeCaseLaunchInput', removeAfterWave: 'W4-E9' },
  { id: 'public:digital-employee:types:EmployeeCaseProjectionDocument', removeAfterWave: 'W4-E9' },
  { id: 'public:digital-employee:types:EmployeeCaseRef', removeAfterWave: 'W4-E9' },
  ...
  { id: 'public:digital-employee:types:EmployeeTypeRef', removeAfterWave: 'W4-E9' },
  { id: 'public:digital-employee:types:EventSubjectInput', removeAfterWave: 'W4-E9' },
  { id: 'public:digital-employee:types:ExactResourceRef', removeAfterWave: 'W4-E9' },
  ...
  { id: 'public:digital-employee:types:TerminalKindClassification', removeAfterWave: 'W4-E9' },
  ...
  { id: 'public:event-center:participants:EventDeliveryParticipant', removeAfterWave: 'W4-E9' },
  { id: 'public:event-center:participants:EventObserverControlParticipant', removeAfterWave: 'W4-E9' },
  { id: 'public:event-center:participants:EventSubscriptionParticipant', removeAfterWave: 'W4-E9' },
  ...
  { id: 'public:event-center:types:EventDeliveryStatusPageDocument', removeAfterWave: 'W4-E9' },
  { id: 'public:event-center:types:EventExactRef', removeAfterWave: 'W4-E9' },
  { id: 'public:event-center:types:EventObservationReceipt', removeAfterWave: 'W4-E9' },
  { id: 'public:event-center:types:EventRecordAuditDocument', removeAfterWave: 'W4-E9' },
  { id: 'public:event-center:types:EventRecordAuditPageDocument', removeAfterWave: 'W4-E9' },
  { id: 'public:event-center:types:EventSubjectRef', removeAfterWave: 'W4-E9' },
  { id: 'public:event-center:types:EventSubscriberRef', removeAfterWave: 'W4-E9' },
  { id: 'public:event-center:types:EventSubscriptionReceipt', removeAfterWave: 'W4-E9' },
  ...
  { id: 'public:execution-contract:types:ExecutionContractCheck', removeAfterWave: 'W4-E9' },
  { id: 'public:execution-contract:types:ExecutionContractImplementation', removeAfterWave: 'W4-E9' },
  { id: 'public:execution-contract:types:ExecutionContractRef', removeAfterWave: 'W4-E9' },
  { id: 'public:execution-contract:types:ExecutionContractValidationReceipt', removeAfterWave: 'W4-E9' },
  ...
  { id: 'public:identity-access:commands:CreateManagedUserCommand', removeAfterWave: 'W4-E0' },
  { id: 'public:identity-access:commands:ExactAccessSnapshot', removeAfterWave: 'W4-E0' },
  { id: 'public:identity-access:commands:InitialUserAccessProvision', removeAfterWave: 'W4-E0' },
  { id: 'public:identity-access:commands:SyncOidcProfile', removeAfterWave: 'W4-E0' },
  { id: 'public:identity-access:commands:UpdateOwnProfileCommand', removeAfterWave: 'W4-E0' },
  { id: 'public:identity-access:commands:UpdateUserAccess', removeAfterWave: 'W4-E0' },
  { id: 'public:identity-access:commands:UpdateUserAccessCommand', removeAfterWave: 'W4-E0' },
  { id: 'public:identity-access:commands:UpdateUserAccessResult', removeAfterWave: 'W4-E0' },
  { id: 'public:identity-access:events:AuthorityRevisionChanged', removeAfterWave: 'W4-E0' },
  { id: 'public:identity-access:events:IdentityAccessEventSink', removeAfterWave: 'W4-E0' },
  { id: 'public:identity-access:participants:AuthenticatedAuthoritySnapshot', removeAfterWave: 'W4-E0' },
  { id: 'public:identity-access:participants:CurrentSubjectAccessResolver', removeAfterWave: 'W4-E0' },
  { id: 'public:identity-access:participants:DelegatedAuthorityRef', removeAfterWave: 'W4-E0' },
  { id: 'public:identity-access:participants:DelegatedAuthorityResolver', removeAfterWave: 'W4-E0' },
  { id: 'public:identity-access:participants:DelegatedOperationContextFactory', removeAfterWave: 'W4-E0' },
  { id: 'public:identity-access:participants:DirectTransport', removeAfterWave: 'W4-E0' },
  { id: 'public:identity-access:participants:DurableSourceAttemptRef', removeAfterWave: 'W4-E0' },
  { id: 'public:identity-access:participants:IdempotentCommandContext', removeAfterWave: 'W4-E0' },
  { id: 'public:identity-access:participants:RequestAuthority', removeAfterWave: 'W4-E0' },
  { id: 'public:identity-access:participants:UserAccessFenceReader', removeAfterWave: 'W4-E0' },
  { id: 'public:identity-access:participants:ValidatedIdempotencyKey', removeAfterWave: 'W4-E0' },
  { id: 'public:identity-access:queries:GetUserAccess', removeAfterWave: 'W4-E0' },
  { id: 'public:identity-access:queries:GetUserAccessQuery', removeAfterWave: 'W4-E0' },
  { id: 'public:identity-access:queries:GetUserGitCommitIdentity', removeAfterWave: 'W4-E0' },
  { id: 'public:identity-access:queries:requireUserAccess', removeAfterWave: 'W4-E0' },
  { id: 'public:identity-access:types:AdminUserAccessView', removeAfterWave: 'W4-E0' },
  { id: 'public:identity-access:types:ManagedUserStatus', removeAfterWave: 'W4-E0' },
  { id: 'public:identity-access:types:ResolvedAuthoritySubject', removeAfterWave: 'W4-E0' },
  ...
  { id: 'public:integration:participants:EventWorkStartOrigin', removeAfterWave: 'W4-B' },
  ...
  { id: 'public:source-control:types:CommitExclusionReceipt', removeAfterWave: 'W5' },
  { id: 'public:source-control:types:CommitPreparedResult', removeAfterWave: 'W5' },
  { id: 'public:source-control:types:OpenRepositoryPublicationSessionResult', removeAfterWave: 'W5' },
  { id: 'public:source-control:types:PrepareRepositoryCommitResult', removeAfterWave: 'W5' },
  { id: 'public:source-control:types:RepositoryCommitPreviewResult', removeAfterWave: 'W5' },
  { id: 'public:source-control:types:RepositoryPublicationGitOptions', removeAfterWave: 'W5' },
  { id: 'public:source-control:types:RepositoryPublicationGitResult', removeAfterWave: 'W5' },
  { id: 'public:source-control:types:RepositoryPublicationSession', removeAfterWave: 'W5' },
  { id: 'public:source-control:types:RepositoryPublishMode', removeAfterWave: 'W5' },
  { id: 'public:source-control:types:RepositoryPublishResult', removeAfterWave: 'W5' },
  { id: 'public:source-control:types:RepositoryTransportCredentialErrorKind', removeAfterWave: 'W5' },
  { id: 'public:source-control:types:RepositoryTransportCredentialSelection', removeAfterWave: 'W5' },
  { id: 'public:source-control:types:WorkspaceExcludeProfileReceipt', removeAfterWave: 'W5' },
  { id: 'public:task-catalog:types:TaskCatalogListQuery', removeAfterWave: 'W4-E10' },
  { id: 'public:task-execution:commands:InheritableRunConfig', removeAfterWave: 'W4-E1' },
  { id: 'public:task-execution:commands:TaskDriveCompletionMode', removeAfterWave: 'W4-E1' },
  { id: 'public:task-execution:commands:TaskDriveCoordinator', removeAfterWave: 'W4-E1' },
  { id: 'public:task-execution:commands:TaskDriveReceipt', removeAfterWave: 'W4-E1' },
  { id: 'public:task-execution:commands:TaskDriveRequest', removeAfterWave: 'W4-E1' },
  { id: 'public:task-execution:commands:TaskDriveRuntimeOptions', removeAfterWave: 'W4-E1' },
  ...
  { id: 'public:task-execution:queries:LoopExitConditionCandidate', removeAfterWave: 'W4-E1' },
  { id: 'public:task-execution:types:ReviewGateSubject', removeAfterWave: 'W4-E1' },
  { id: 'public:task-execution:types:ReviewGateSubjectReadModel', removeAfterWave: 'W4-E1' },
  { id: 'public:task-execution:types:SETTLES_WITHOUT_ROW_KINDS', removeAfterWave: 'W4-E1' },
  { id: 'public:task-execution:types:SourceTerminationFence', removeAfterWave: 'W4-E1' },
  { id: 'public:task-execution:types:TaskCallGraphWorkspace', removeAfterWave: 'W4-E1' },
  { id: 'public:task-execution:types:TaskExecutionCommandErrorCode', removeAfterWave: 'W4-E1' },
  { id: 'public:task-execution:types:TaskExecutionCommandResult', removeAfterWave: 'W4-E1' },
  { id: 'public:task-execution:types:TaskReviewNodeCatalog', removeAfterWave: 'W4-E1' },
  { id: 'public:task-execution:types:TaskReviewNodeCatalogReadModel', removeAfterWave: 'W4-E1' },
  { id: 'public:task-execution:types:TaskReviewNodeDescriptor', removeAfterWave: 'W4-E1' },
  { id: 'public:task-execution:types:TaskStatusProjectionReadModel', removeAfterWave: 'W4-E1' },
  { id: 'public:task-execution:types:TaskStatusProjectionSnapshot', removeAfterWave: 'W4-E1' },
  { id: 'public:task-execution:types:TaskStopProjection', removeAfterWave: 'W4-E1' },
  { id: 'public:task-execution:types:WebhookTerminalCause', removeAfterWave: 'W4-E1' },
  { id: 'public:task-execution:types:WrapperExecutionKind', removeAfterWave: 'W4-E1' },
  { id: 'public:task-execution:types:WrapperExecutionScope', removeAfterWave: 'W4-E1' },
