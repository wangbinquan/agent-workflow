...
export const SYNC_TRANSACTION_DEBT: readonly string[] = [
  ...
  'modules/intent/infrastructure/sqliteIntentApplyArtifactLifecycle.ts: 1',
  'modules/intent/infrastructure/sqliteIntentApplyOperations.ts: 10',
  'modules/intent/infrastructure/sqliteIntentSqlProgramRunner.ts: 2',
  'modules/resource-catalog/infrastructure/aggregateAdapters/legacyResourcePackageMutationParticipants.ts: 1',
  'modules/resource-catalog/infrastructure/legacy/agent.ts: 5',
  'modules/resource-catalog/infrastructure/legacy/importRefs.ts: 1',
  'modules/resource-catalog/infrastructure/legacy/skill.ts: 10',
  'modules/resource-catalog/infrastructure/legacy/skillBootVerify.ts: 2',
  'modules/resource-catalog/infrastructure/legacy/skillDeleteOp.ts: 5',
  'modules/resource-catalog/infrastructure/legacy/skillIdentityMigration.ts: 1',
  'modules/resource-catalog/infrastructure/legacy/skillMigrateOp.ts: 4',
  'modules/resource-catalog/infrastructure/legacy/skillOpRecoveryDriver.ts: 4',
  'modules/resource-catalog/infrastructure/legacy/skillVersion.ts: 9',
  ...
  'modules/resource-catalog/infrastructure/sqliteResourceAclRepository.ts: 1',
  'modules/resource-catalog/infrastructure/sqliteResourcePackageMaintenance.ts: 4',
