...
describe('RFC-305 identity-access architecture', () => {
  ...
  test('module composition and public contracts have only the reviewed consumers', () => {
    expect(identityAccessImportsOutsideOwner()).toEqual([
      ...
      'packages/backend/src/modules/intent/inbound/intentSessionRoutes.ts -> @/modules/identity-access/public/participants',
      'packages/backend/src/modules/knowledge-evolution/inbound/fusionRoutes.ts -> @/modules/identity-access/public/participants',
      'packages/backend/src/modules/memory/application/ports/resourceScopeAccess.ts -> @/modules/identity-access/public/participants',
      'packages/backend/src/modules/memory/composition.ts -> @/modules/identity-access/public/participants',
      'packages/backend/src/modules/memory/infrastructure/postgresqlMemoryCatalogOperations.ts -> @/modules/identity-access/public/participants',
      'packages/backend/src/modules/memory/infrastructure/sqliteMemoryCatalog.ts -> @/modules/identity-access/public/participants',
      'packages/backend/src/modules/memory/infrastructure/sqliteMemoryCatalogOperations.ts -> @/modules/identity-access/public/participants',
      ...
      'packages/backend/src/modules/resource-catalog/application/resourceCatalogQuery.ts -> @/modules/identity-access/public/participants',
      'packages/backend/src/modules/resource-catalog/composition/catalogOperationDescriptors.ts -> @/modules/identity-access/public/participants',
      'packages/backend/src/modules/resource-catalog/composition/intentContextAuthorization.ts -> @/modules/identity-access/public/participants',
      'packages/backend/src/modules/resource-catalog/composition/providerResourceCatalog.ts -> @/modules/identity-access/public/participants',
      'packages/backend/src/modules/resource-catalog/composition/resourcePackageOperations.ts -> @/modules/identity-access/public/participants',
      'packages/backend/src/modules/resource-catalog/infrastructure/agentImportSnapshot.ts -> @/modules/identity-access/public/participants',
      'packages/backend/src/modules/resource-catalog/infrastructure/aggregateAdapters/postgresqlIntentApplyResourceParticipants.ts -> @/modules/identity-access/public/participants',
      'packages/backend/src/modules/resource-catalog/infrastructure/aggregateAdapters/postgresqlIntentApplyResourcePorts.ts -> @/modules/identity-access/public/participants',
      'packages/backend/src/modules/resource-catalog/infrastructure/aggregateAdapters/postgresqlResourceScopeAuthorization.ts -> @/modules/identity-access/public/participants',
      'packages/backend/src/modules/resource-catalog/infrastructure/postgresqlAgentImportQueries.ts -> @/modules/identity-access/public/participants',
      'packages/backend/src/modules/resource-catalog/infrastructure/postgresqlCatalogQuery.ts -> @/modules/identity-access/public/participants',
      'packages/backend/src/modules/resource-catalog/infrastructure/sqliteAgentImportQueries.ts -> @/modules/identity-access/public/participants',
      ...
      'packages/backend/src/modules/task-execution/infrastructure/postgresqlTaskCatalogSources.ts -> @/modules/identity-access/public/operations',
      ...
      'packages/backend/src/modules/task-execution/infrastructure/sqliteTaskCatalogSources.ts -> @/modules/identity-access/public/operations',
      ...
      'packages/backend/src/modules/task-execution/infrastructure/taskListPage/postgresql.ts -> @/modules/identity-access/public/operations',
      ...
      'packages/backend/src/modules/task-execution/infrastructure/taskListPage/sqlite.ts -> @/modules/identity-access/public/operations',
      ...
      'packages/backend/src/routes/databaseMigrations.ts -> @/modules/identity-access/public/participants',
      ...
      'packages/backend/src/routes/resourcePackages.ts -> @/modules/identity-access/public/participants',
      'packages/backend/src/routes/restore.ts -> @/modules/identity-access/public/participants',
      'packages/backend/src/routes/scheduledTasks.ts -> @/modules/identity-access/public/participants',
      ...
      'packages/backend/src/services/ownerScopedName.ts -> @/modules/identity-access/composition/providerOperations',
      'packages/backend/src/services/ownerScopedName.ts -> @/modules/identity-access/public/operations',
      'packages/backend/src/services/resourcePackage/executionAdapter.ts -> @/modules/identity-access/public/participants',
