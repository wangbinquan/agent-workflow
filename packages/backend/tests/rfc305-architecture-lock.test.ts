...
describe('RFC-305 identity-access architecture', () => {
  ...
  test('module composition and public contracts have only the reviewed consumers', () => {
    expect(identityAccessImportsOutsideOwner()).toEqual([
      ...
      'packages/backend/src/routes/intentSessions.ts -> @/modules/identity-access/public/participants',
      ...
      'packages/backend/src/services/intent/resourceCatalog.ts -> @/modules/identity-access/public/participants',
