...
const REGISTERED_PREEXISTING_DEEP_IMPORTS = new Set([
  'packages/backend/src/cli/start.ts:@/modules/task-execution/infrastructure/runtimeSessionLeaseOperations',
  ...
  'packages/backend/src/services/startTaskDeps.ts:@/modules/task-execution/infrastructure/runtimeSessionLeaseOperations',
