...
describe('RFC-054 W1-6 — rolling upgrade from old home reaches HEAD + runs toy task', () => {
  ...
  test('HEAD journal has 125 entries (sanity — locks the freeze target indices)', () => {
    ...
    // RFC-238 MCP runtime playground bumped to 125 with 0125.
    expect(HEAD_TOTAL_MIGRATIONS).toBe(125)
  })
